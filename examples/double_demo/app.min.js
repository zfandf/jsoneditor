...
function OnlineStore(e) {
	this.url = e.url,
		...
		this.saving = !1,
		this.revs = {},
	"/" !== this.url[this.url.length - 1] && (this.url += "/")
}
function Splitter(e) {
	if (!e || !e.container)
...
function newFeatureInfo() {
	if (!localStorage.hideOnlineStorageMessage && new Date < new Date(2014,10,1)) {
		...
		document.getElementById("gotIt").onclick = function() {
			localStorage.hideOnlineStorageMessage = !0,
				app.notify.removeMessage(e)
		}
	}
}
		...
		e.addEventListener("drop", function(e) {
				if (e.stopPropagation(),
					...
					if ("undefined" != typeof window.FileReader) {
						...
						t(new Error("Sorry, drag and drop is not supported by your browser."))
				}
			}
		)
}
...
(this, function() {
		...
		([function(e, t, i) {
			function n(e, t, i) {
				...
				if (t && (t.error && (console.warn('Option "error" has been renamed to "onError"'),
					...
					t.editable && (console.warn('Option "editable" has been renamed to "onEditable"'),
						...
						delete t.editable),
						t)) {
					var r = ["ace", "onChange", "onEditable", "onError", "onModeChange", "escapeUnicode", "history", "mode", "modes", "name", "indentation", "theme"];
			...
			var o = i(1)
				...
				, s = i(3);
			n.modes = {},
				n.prototype._create = function(e, t, i) {
					this.container = e,
						this.options = t || {},
						this.json = i || {};
				...
				n.prototype.setMode = function(e) {
					var t, i, o = this.container, r = s.extend({}, this.options), a = r.mode;
					r.mode = e;
					var l = n.modes[e];
					if (!l)
					...
					try {
						var c = "text" == l.data;
						if (i = this.getName(),
								t = this[c ? "getText" : "get"](),
								this._delete(),
								s.clear(this),
								s.extend(this, l.mixin),
								this.create(o, r),
								this.setName(i),
								this[c ? "setText" : "set"](t),
						...
						if ("function" == typeof r.onModeChange && e !== a)
							try {
								r.onModeChange(e, a)
							} catch (h) {
								console.error(h)
				...
				n.registerMode = function(e) {
					...
					if (s.isArray(e))
						...
						if ("function" != typeof e.mixin.create)
							throw new Error('Required function "create" missing on mixin');
						var r = ["setMode", "registerMode", "modes"];
						for (t = 0; t < r.length; t++)
							if (i = r[t],
								i in e.mixin)
								throw new Error('Reserved property "' + i + '" not allowed in mixin');
						n.modes[o] = e
					}
				}
				,
			...
			, function(e, t, i) {
				...
				var d = void 0
					, u = null ;
				h.set = function(e, t) {
					if (t && (c.log('Warning: second parameter "name" is deprecated. Use setName(name) instead.'),
							this.options.name = t),
						e instanceof Function || void 0 === e)
						this.clear();
					else {
					...
					h.focus = function() {
						...
						e ? e.focus() : this.node.dom.expand ? this.node.dom.expand.focus() : this.node.dom.menu ? this.node.dom.menu.focus() : (e = this.frame.querySelector("button"),
						e && e.focus())
					}
					,
					h.clear = function() {
						this.node && (this.node.collapse(),
					...
					h.search = function(e) {
						var t;
						return this.node ? (this.content.removeChild(this.table),
							t = this.node.search(e),
							this.content.appendChild(this.table)) : t = [],
							t
					}
					,
					h.expandAll = function() {
						this.node && (this.content.removeChild(this.table),
							this.node.expand(),
							this.content.appendChild(this.table))
					}
					,
					...
					h._onAction = function(e, t) {
						if (this.history && this.history.add(e, t),
								this.options.onChange)
							try {
								this.options.onChange()
							} catch (i) {
								c.log("Error in change callback: ", i)
							}
					}
					,
					h.startAutoScroll = function(e) {
						var t = this
							, i = this.content
							, n = c.getAbsoluteTop(i)
							, o = i.clientHeight
							, r = n + o
							, s = 24
							, a = 50;
						n + s > e && i.scrollTop > 0 ? this.autoScrollStep = (n + s - e) / 3 : e > r - s && o + i.scrollTop < i.scrollHeight ? this.autoScrollStep = (r - s - e) / 3 : this.autoScrollStep = void 0,
					...
					h.setSelection = function(e) {
						e && ("scrollTop" in e && this.content && (this.content.scrollTop = e.scrollTop),
						e.nodes && this.select(e.nodes),
						e.range && c.setSelectionOffset(e.range),
						e.dom && e.dom.focus())
					}
					,
					...
					h.scrollTo = function(e, t) {
						...
						if (i) {
							var n = this;
							n.animateTimeout && (clearTimeout(n.animateTimeout),
								delete n.animateTimeout),
							n.animateCallback && (n.animateCallback(!1),
								delete n.animateCallback);
							var o = i.clientHeight
								...
								, a = function() {
									var e = i.scrollTop
										, o = s - e;
									Math.abs(o) > 3 ? (i.scrollTop += o / 3,
										n.animateCallback = t,
										n.animateTimeout = setTimeout(a, 50)) : (t && t(!0),
										i.scrollTop = s,
										delete n.animateTimeout,
										delete n.animateCallback)
								}
					...
					h._createFrame = function() {
						...
						this.frame.onclick = function(t) {
							var i = t.target;
							e(t),
							"BUTTON" == i.nodeName && t.preventDefault()
						}
							,
						...
						if (n.title = "Collapse all fields",
								n.className = "jsoneditor-collapse-all",
								n.onclick = function() {
									t.collapseAll()
								}
								,
							...
							o.className = "jsoneditor-undo jsoneditor-separator",
								o.title = "Undo last action (Ctrl+Z)",
								o.onclick = function() {
									t._onUndo()
								}
								,
							...
							s.className = "jsoneditor-redo",
								s.title = "Redo (Ctrl+Shift+Z)",
								s.onclick = function() {
									t._onRedo()
								}
								,
								...
								this.history.onChange = function() {
									o.disabled = !t.history.canUndo(),
										s.disabled = !t.history.canRedo()
								}
								,
					...
					h._onEvent = function(e) {
						"keydown" == e.type && this._onKeyDown(e),
						"focus" == e.type && (u = e.target),
						"mousedown" == e.type && this._startDragDistance(e),
						("mousemove" == e.type || "mouseup" == e.type || "click" == e.type) && this._updateDragDistance(e);
						var t = a.getNodeFromTarget(e.target);
						if (t && t.selected) {
							if ("click" == e.type) {
								if (e.target == t.dom.menu)
							...
							"mousedown" == e.type && (this.deselect(),
								t && e.target == t.dom.drag ? a.onDragStart(t, e) : (!t || e.target != t.dom.field && e.target != t.dom.value) && this._onMultiSelectStart(e));
						t && t.onEvent(e)
					}
					,
					...
					h._updateDragDistance = function(e) {
						...
						return this.dragDistanceEvent.dragDistance = Math.sqrt(t * t + i * i),
					...
					h._onMultiSelect = function(e) {
						if (e.preventDefault(),
								this._updateDragDistance(e),
								e.hasMoved) {
							var t = a.getNodeFromTarget(e.target);
							t && (null  == this.multiselection.start && (this.multiselection.start = t),
								this.multiselection.end = t),
								this.deselect();
							var i = this.multiselection.start
								, n = this.multiselection.end || this.multiselection.start;
							i && n && (this.multiselection.nodes = this._findTopLevelNodes(i, n),
					...
					h._onMultiSelectEnd = function(e) {
						...
						this.mousemove && (c.removeEventListener(window, "mousemove", this.mousemove),
							delete this.mousemove),
						this.mouseup && (c.removeEventListener(window, "mouseup", this.mouseup),
							delete this.mouseup)
					}
					,
					h.deselect = function(e) {
						...
						e && (this.multiselection.start = null ,
							this.multiselection.end = null )
					}
					,
					h.select = function(e) {
					...
					h._findTopLevelNodes = function(e, t) {
						for (var i = e.getPath(), n = t.getPath(), o = 0; o < i.length && i[o] === n[o]; )
							o++;
						var r = i[o - 1]
							, s = i[o]
							, a = n[o];
						if (s && a || (r.parent ? (s = r,
								a = r,
								r = r.parent) : (s = r.childs[0],
								a = r.childs[r.childs.length - 1])),
							r && s && a) {
						...
						if (9 == t && setTimeout(function() {
							...
							if (i && 70 == t)
								this.searchBox.dom.search.focus(),
									...
									o = !0;
							else if (114 == t || i && 71 == t) {
								var r = !0;
								n ? this.searchBox.previous(r) : this.searchBox.next(r),
									o = !0
							}
						this.history && (i && !n && 90 == t ? (this._onUndo(),
							o = !0) : i && n && 90 == t && (this._onRedo(),
							o = !0)),
						o && (e.preventDefault(),
							e.stopPropagation())
					}
					...
					h._createTable = function() {
						...
						"tree" === this.options.mode && (t = document.createElement("col"),
							t.width = "24px",
			...
			, function(e, t, i) {
				...
				a.create = function(e, t) {
					t = t || {},
						this.options = t,
						t.indentation ? this.indentation = Number(t.indentation) : this.indentation = 2;
					var i = t.ace ? t.ace : n;
					this.mode = "code" == t.mode ? "code" : "text",
					"code" == this.mode && "undefined" == typeof i && (this.mode = "text",
						s.log("WARNING: Cannot load code editor, Ace library not loaded. Falling back to plain text editor")),
						this.theme = t.theme || "ace/theme/jsoneditor";
					var o = this;
					this.container = e,
						this.dom = {},
					...
					a.className = "jsoneditor-format",
						a.title = "Format JSON data, with proper indentation and line feeds (Ctrl+\\)",
						this.menu.appendChild(a),
						a.onclick = function() {
							try {
								o.format()
					...
					if (l.className = "jsoneditor-compact",
							l.title = "Compact JSON data, remove all whitespaces (Ctrl+Shift+\\)",
						...
						var c = r.create(this, this.options.modes, this.options.mode);
						this.menu.appendChild(c),
							this.dom.modeBox = c
					}
					if (this.content = document.createElement("div"),
						...
						h.$blockScrolling = 1 / 0,
							h.setTheme(this.theme),
							h.setShowPrintMargin(!1),
							h.setFontSize(13),
							h.getSession().setMode("ace/mode/json"),
							h.getSession().setTabSize(this.indentation),
							h.getSession().setUseSoftTabs(!0),
							h.getSession().setUseWrapMode(!0),
							h.commands.bindKey("Ctrl-L", null ),
							h.commands.bindKey("Command-L", null ),
							this.aceEditor = h,
						this.hasOwnProperty("editor") || Object.defineProperty(this, "editor", {
							get: function() {
								return console.warn('Property "editor" has been renamed to "aceEditor".'),
									o.aceEditor
							},
							set: function(e) {
						...
						d.appendChild(document.createTextNode("powered by ace")),
							d.href = "http://ace.ajax.org",
							d.target = "_blank",
							d.className = "jsoneditor-poweredBy",
							d.onclick = function() {
								window.open(d.href, d.target)
							}
							,
							this.menu.appendChild(d),
						t.onChange && h.on("change", t.onChange)
					} else {
						var u = document.createElement("textarea");
						u.className = "jsoneditor-text",
							u.spellcheck = !1,
							this.content.appendChild(u),
							this.textarea = u,
						t.onChange && (null  === this.textarea.oninput ? this.textarea.oninput = t.onChange() : this.textarea.onchange = t.onChange())
					}
				}
					,
					a._onKeyDown = function(e) {
						var t = e.which || e.keyCode
							, i = !1;
						220 == t && e.ctrlKey && (e.shiftKey ? this.compact() : this.format(),
							i = !0),
						i && (e.preventDefault(),
							e.stopPropagation())
					}
					...
					a.setText = function(e) {
						this.options.escapeUnicode === !0 ? text = s.escapeUnicodeChars(e) : text = e,
						this.textarea && (this.textarea.value = text),
						this.aceEditor && this.aceEditor.setValue(text, -1)
					}
					,
					e.exports = [{
						mode: "text",
			...
			, function(e, t, i) {
				...
				t.parse = function(e) {
					...
					t.sanitize = function(e) {
						...
						function a() {
							for (var e = ["null", "true", "false"], i = "", n = t(), o = /[a-zA-Z_$\d]/; o.test(n); )
								i += n,
									c++,
									n = t();
							-1 === e.indexOf(i) ? l.push('"' + i + '"') : l.push(i)
						}
						var l = []
							, c = 0
							, h = e.match(/^\s*(\/\*(.|[\r\n])*?\*\/)?\s*[\da-zA-Z_$]+\s*\(([\s\S]*)\)\s*;?\s*$/);
						for (h && (e = h[3]); c < e.length; ) {
							var d = t();
							"/" === d && "*" === i() ? r() : "'" === d || '"' === d ? s(d) : /[a-zA-Z_$]/.test(d) && o() ? a() : (l.push(d),
								c++)
						}
						return l.join("")
					}
				...
				t.isUrl = function(e) {
					...
					t.stripFormatting = function(e) {
						for (var i = e.childNodes, n = 0, o = i.length; o > n; n++) {
							var r = i[n];
					...
					t.selectContentEditable = function(e) {
						if (e && "DIV" == e.nodeName) {
							var t, i;
							window.getSelection && document.createRange && (i = document.createRange(),
					...
					t.getInnerText = function(e, i) {
						...
						if (n && (i = {
								...
								e.nodeValue)
							return i.flush() + e.nodeValue;
						if (e.hasChildNodes()) {
							for (var o = e.childNodes, r = "", s = 0, a = o.length; a > s; s++) {
								var l = o[s];
								if ("DIV" == l.nodeName || "P" == l.nodeName) {
									var c = o[s - 1]
										, h = c ? c.nodeName : void 0;
									h && "DIV" != h && "P" != h && "BR" != h && (r += "\n",
										i.flush()),
										r += t.getInnerText(l, i),
										i.set("\n")
								} else
									"BR" == l.nodeName ? (r += i.flush(),
										i.set("\n")) : r += t.getInnerText(l, i)
							}
							return r
						}
				...
				;
				var r = -1;
				t.addEventListener = function(e, i, n, o) {
					if (e.addEventListener)
						return void 0 === o && (o = !1),
						"mousewheel" === i && t.isFirefox() && (i = "DOMMouseScroll"),
					...
					if (e.attachEvent) {
						var r = function() {
							...
							;
						return e.attachEvent("on" + i, r),
							r
					}
				}
					,
					t.removeEventListener = function(e, i, n, o) {
						e.removeEventListener ? (void 0 === o && (o = !1),
						"mousewheel" === i && t.isFirefox() && (i = "DOMMouseScroll"),
							e.removeEventListener(i, n, o)) : e.detachEvent && e.detachEvent("on" + i, n)
					}
			}
			, function(e, t, i) {
				function n() {
				...
				n.prototype.highlight = function(e) {
					this.locked || (this.node != e && (this.node && this.node.setHighlight(!1),
						this.node = e,
					...
					n.prototype.unhighlight = function() {
						if (!this.locked) {
							var e = this;
							this.node && (this._cancelUnhighlight(),
				...
				n.prototype.onChange = function() {}
					...
					n.prototype.undo = function() {
						if (this.canUndo()) {
							...
							if (e) {
								...
								t && t.undo ? (t.undo(e.params),
								e.params.oldSelection && this.editor.setSelection(e.params.oldSelection)) : o.log('Error: unknown action "' + e.action + '"')
							}
							this.index--,
								this.onChange()
						}
					...
					n.prototype.redo = function() {
						if (this.canRedo()) {
							...
							if (e) {
								var t = this.actions[e.action];
								t && t.redo ? (t.redo(e.params),
								e.params.newSelection && this.editor.setSelection(e.params.newSelection)) : o.log('Error: unknown action "' + e.action + '"')
							}
							this.onChange()
						}
					}
			...
			, function(e, t, i) {
				function n(e, t) {
					...
					this.dom.results = a,
						a.className = "jsoneditor-results",
						s.appendChild(a),
					...
					d.className = "jsoneditor-refresh",
						s = document.createElement("td"),
						s.appendChild(d),
						r.appendChild(s);
					...
					g.title = "Previous result (Shift+Enter)",
						g.className = "jsoneditor-previous",
						g.onclick = function() {
							i.previous()
						}
						,
				...
				n.prototype.next = function(e) {
					...
					n.prototype.previous = function(e) {
						if (void 0 != this.results) {
							var t = this.results.length - 1
								, i = void 0 != this.resultIndex ? this.resultIndex - 1 : t;
							0 > i && (i = t),
								this._setActiveResult(i, e)
						}
					}
					,
					n.prototype._setActiveResult = function(e, t) {
						if (this.activeResult) {
							var i = this.activeResult.node
								, n = this.activeResult.elem;
							"field" == n ? delete i.searchFieldActive : delete i.searchValueActive,
								i.updateDom()
						}
						if (!this.results || !this.results[e])
							return this.resultIndex = void 0,
								void (this.activeResult = void 0);
						this.resultIndex = e;
						var o = this.results[this.resultIndex].node
							, r = this.results[this.resultIndex].elem;
						"field" == r ? o.searchFieldActive = !0 : o.searchValueActive = !0,
					...
					n.prototype._onKeyDown = function(e) {
						var t = e.which;
						27 == t ? (this.dom.search.value = "",
							this._onSearch(),
							e.preventDefault(),
							e.stopPropagation()) : 13 == t && (e.ctrlKey ? this._onSearch(!0) : e.shiftKey ? this.previous() : this.next(),
							e.preventDefault(),
							e.stopPropagation())
					}
					,
			...
			, function(e, t, i) {
				function n(e, t) {
					function i(e, t, o) {
						o.forEach(function(o) {
								if ("separator" == o.type) {
									...
									r.className = "jsoneditor-separator",
									...
									e.appendChild(a);
									var l = document.createElement("button");
									if (l.className = o.className,
											s.button = l,
										o.title && (l.title = o.title),
										o.click && (l.onclick = function() {
												n.hide(),
													o.click()
											}
										),
										...
										if (o.click) {
											...
											var d = document.createElement("button");
											s.buttonExpand = d,
												d.className = "jsoneditor-expand",
												d.innerHTML = '<div class="jsoneditor-expand"></div>',
												a.appendChild(d),
											o.submenuTitle && (d.title = o.submenuTitle),
												h = d
										} else {
										...
										s.ul = g,
											g.className = "jsoneditor-menu",
											g.style.height = "0",
											a.appendChild(g),
											i(g, f, o.submenu)
									} else
										l.innerHTML = '<div class="jsoneditor-icon"></div>' + o.text;
									t.push(s)
								}
							}
						)
					...
					var r = document.createElement("div");
					r.className = "jsoneditor-contextmenu-root",
						o.root = r;
				...
				n.prototype._getVisibleButtons = function() {
					...
					return this.dom.items.forEach(function(i) {
							e.push(i.button),
							i.buttonExpand && e.push(i.buttonExpand),
							i.subItems && i == t.expandedItem && i.subItems.forEach(function(t) {
									e.push(t.button),
					...
					n.prototype.show = function(e, t) {
						...
						if (t) {
							...
							r.bottom + this.maxHeight < s.bottom || r.top - this.maxHeight > s.top && (i = !1)
						}
						if (i) {
							var a = e.offsetHeight;
							this.dom.menu.style.left = "0px",
								this.dom.menu.style.top = a + "px",
						...
						this.eventListeners.mousedown = o.addEventListener(window, "mousedown", function(e) {
							...
							this.selection = o.getSelection(),
							this.anchor = e,
							setTimeout(function() {
									c.dom.focusButton.focus()
								}
								, 0),
						n.visibleMenu && n.visibleMenu.hide(),
							n.visibleMenu = this
					}
					,
					n.prototype.hide = function() {
						...
						for (var e in this.eventListeners)
							if (this.eventListeners.hasOwnProperty(e)) {
								...
								t && o.removeEventListener(window, e, t),
					...
					n.prototype._onExpandItem = function(e) {
						var t = this
							, i = e == this.expandedItem
							, n = this.expandedItem;
						if (n && (n.ul.style.height = "0",
								n.ul.style.padding = "",
								setTimeout(function() {
										t.expandedItem != n && (n.ul.style.display = "",
											o.removeClassName(n.ul.parentNode, "jsoneditor-selected"))
									}
									, 300),
							...
							r.clientHeight;
							setTimeout(function() {
									t.expandedItem == e && (r.style.height = 24 * r.childNodes.length + "px",
										r.style.padding = "5px 10px")
								}
								, 0),
								o.addClassName(r.parentNode, "jsoneditor-selected"),
								this.expandedItem = e
						}
					}
					,
					n.prototype._onKeyDown = function(e) {
						var t, i, n, r, s = e.target, a = e.which, l = !1;
						27 == a ? (this.selection && o.setSelection(this.selection),
						this.anchor && this.anchor.focus(),
							this.hide(),
							l = !0) : 9 == a ? e.shiftKey ? (t = this._getVisibleButtons(),
							i = t.indexOf(s),
						0 == i && (t[t.length - 1].focus(),
							l = !0)) : (t = this._getVisibleButtons(),
							i = t.indexOf(s),
						i == t.length - 1 && (t[0].focus(),
							l = !0)) : 37 == a ? ("jsoneditor-expand" == s.className && (t = this._getVisibleButtons(),
							i = t.indexOf(s),
							n = t[i - 1],
						n && n.focus()),
							l = !0) : 38 == a ? (t = this._getVisibleButtons(),
							i = t.indexOf(s),
							n = t[i - 1],
						n && "jsoneditor-expand" == n.className && (n = t[i - 2]),
						n || (n = t[t.length - 1]),
						n && n.focus(),
							l = !0) : 39 == a ? (t = this._getVisibleButtons(),
							i = t.indexOf(s),
							r = t[i + 1],
						r && "jsoneditor-expand" == r.className && r.focus(),
							l = !0) : 40 == a && (t = this._getVisibleButtons(),
							i = t.indexOf(s),
							r = t[i + 1],
						r && "jsoneditor-expand" == r.className && (r = t[i + 2]),
						r || (r = t[0]),
						r && (r.focus(),
							l = !0),
							l = !0),
			...
			, function(e, t, i) {
				function n(e, t) {
					this.editor = e,
						this.dom = {},
						this.expanded = !1,
						t && t instanceof Object ? (this.setField(t.field, t.fieldEditable),
							this.setValue(t.value, t.type)) : (this.setField(""),
							this.setValue(null ))
				}
				var o = i(7)
					, r = i(12)
					, s = i(3);
				n.prototype._updateEditability = function() {
					if (this.editable = {
							field: !0,
							value: !0
						},
						this.editor && (this.editable.field = "tree" === this.editor.options.mode,
						...
						"boolean" == typeof e ? (this.editable.field = e,
							this.editable.value = e) : ("boolean" == typeof e.field && (this.editable.field = e.field),
					...
					n.prototype.setValue = function(e, t) {
						var i, o, r = this.childs;
						if (r)
							for (; r.length; )
								this.removeChild(r[0]);
						if (this.type = this._getType(e),
							t && t != this.type) {
							if ("string" != t || "auto" != this.type)
						...
						if ("array" == this.type) {
							...
							for (var s = 0, a = e.length; a > s; s++)
								i = e[s],
								void 0 === i || i instanceof Function || (o = new n(this.editor,{
									value: i
								}),
									this.appendChild(o));
							this.value = ""
					...
					n.prototype.clone = function() {
						...
						if (e.type = this.type,
								e.field = this.field,
								e.fieldInnerText = this.fieldInnerText,
								e.fieldEditable = this.fieldEditable,
								e.value = this.value,
								e.valueInnerText = this.valueInnerText,
					...
					n.prototype.expand = function(e) {
						this.childs && (this.expanded = !0,
						this.dom.expand && (this.dom.expand.className = "jsoneditor-expanded"),
							this.showChilds(),
						e !== !1 && this.childs.forEach(function(t) {
								t.expand(e)
							}
						))
					}
					...
					n.prototype.collapse = function(e) {
						this.childs && (this.hideChilds(),
						e !== !1 && this.childs.forEach(function(t) {
								t.collapse(e)
							}
						),
						this.dom.expand && (this.dom.expand.className = "jsoneditor-collapsed"),
							this.expanded = !1)
					}
					,
					...
					n.prototype.appendChild = function(e) {
						if (this._hasChilds()) {
							if (e.setParent(this),
								...
								"array" == this.type && (e.index = this.childs.length),
									this.childs.push(e),
									this.expanded) {
								var t = e.getDom()
									, i = this.getAppend()
									, n = i ? i.parentNode : void 0;
								i && n && n.insertBefore(t, i),
									e.showChilds()
							}
							this.updateDom({
								updateIndexes: !0
					...
					n.prototype.moveBefore = function(e, t) {
						if (this._hasChilds()) {
							...
							e.parent && e.parent.removeChild(e),
								t instanceof a ? this.appendChild(e) : this.insertBefore(e, t),
							i && i.removeChild(n)
						}
					}
					,
					...
					n.prototype.search = function(e) {
						...
						if (delete this.searchField,
								delete this.searchValue,
							void 0 != this.field) {
							var o = String(this.field).toLowerCase();
							t = o.indexOf(n),
							-1 != t && (this.searchField = !0,
								i.push({
									node: this,
									elem: "field"
								})),
							...
							switch (e) {
								...
								case "expand":
									this._hasChilds() ? t.expand.focus() : t.field && this.fieldEditable ? (t.field.focus(),
										s.selectContentEditable(t.field)) : t.value && !this._hasChilds() ? (t.value.focus(),
										s.selectContentEditable(t.value)) : t.menu.focus();
									break;
								case "field":
									t.field && this.fieldEditable ? (t.field.focus(),
										s.selectContentEditable(t.field)) : t.value && !this._hasChilds() ? (t.value.focus(),
										s.selectContentEditable(t.value)) : this._hasChilds() ? t.expand.focus() : t.menu.focus();
									break;
								case "value":
								default:
									t.value && !this._hasChilds() ? (t.value.focus(),
										s.selectContentEditable(t.value)) : t.field && this.fieldEditable ? (t.field.focus(),
										s.selectContentEditable(t.field)) : this._hasChilds() ? t.expand.focus() : t.menu.focus()
							}
						}
					}
					,
					...
					n.prototype._move = function(e, t) {
						if (e != t) {
							if (e.containsNode(this))
								throw new Error("Cannot move a field into a child of itself");
							e.parent && e.parent.removeChild(e);
							var i = e.clone();
							e.clearDom(),
								t ? this.insertBefore(i, t) : this.appendChild(i)
						}
					}
					,
					...
					n.prototype.changeType = function(e) {
						...
						if (t != e) {
							if ("string" != e && "auto" != e || "string" != t && "auto" != t) {
								...
								var o = i && i.parentNode ? i.nextSibling : void 0;
								this.hide(),
									this.clearDom(),
									this.type = e,
									"object" == e ? (this.childs || (this.childs = []),
								...
								n && (o ? n.insertBefore(this.getDom(), o) : n.appendChild(this.getDom())),
									this.showChilds()
							} else
								this.type = e;
							("auto" == e || "string" == e) && ("string" == e ? this.value = String(this.value) : this.value = this._stringCast(String(this.value)),
								this.focus()),
								this.updateDom({
									updateIndexes: !0
								})
					...
					n.prototype._getDomValue = function(e) {
						if (this.dom.value && "array" != this.type && "object" != this.type && (this.valueInnerText = s.getInnerText(this.dom.value)),
							void 0 != this.valueInnerText)
							try {
								var t;
								if ("string" == this.type)
									t = this._unescapeHTML(this.valueInnerText);
								else {
					...
					n.prototype._updateDomValue = function() {
						...
						if (e) {
							var t = ["jsoneditor-value"]
								, i = this.value
								, n = "auto" == this.type ? s.type(i) : this.type
								, o = "string" == n && s.isUrl(i);
							t.push("jsoneditor-" + n),
							o && t.push("jsoneditor-url");
							var r = "" == String(this.value) && "array" != this.type && "object" != this.type;
							if (r && t.push("jsoneditor-empty"),
								this.searchValueActive && t.push("jsoneditor-highlight-active"),
								this.searchValue && t.push("jsoneditor-highlight"),
									e.className = t.join(" "),
								"array" == n || "object" == n) {
								var a = this.childs ? this.childs.length : 0;
								e.title = this.type + " containing " + a + " items"
							} else
								o && this.editable.value ? e.title = "Ctrl+Click or Ctrl+Enter to open url in new window" : e.title = "";
							s.stripFormatting(e)
						}
					}
					,
					n.prototype._updateDomField = function() {
						...
						if (e) {
							...
							t ? s.addClassName(e, "jsoneditor-empty") : s.removeClassName(e, "jsoneditor-empty"),
								this.searchFieldActive ? s.addClassName(e, "jsoneditor-highlight-active") : s.removeClassName(e, "jsoneditor-highlight-active"),
								this.searchField ? s.addClassName(e, "jsoneditor-highlight") : s.removeClassName(e, "jsoneditor-highlight"),
								s.stripFormatting(e)
						}
					}
					,
					n.prototype._getDomField = function(e) {
						if (this.dom.field && this.fieldEditable && (this.fieldInnerText = s.getInnerText(this.dom.field)),
							void 0 != this.fieldInnerText)
							try {
					...
					n.prototype.getDom = function() {
						...
						if (e.tr)
							return e.tr;
						if (this._updateEditability(),
								e.tr = document.createElement("tr"),
								e.tr.node = this,
							...
							if (this.editable.field && this.parent) {
								var i = document.createElement("button");
								e.drag = i,
									i.className = "jsoneditor-dragarea",
									i.title = "Drag to move this field (Alt+Shift+Arrows)",
									t.appendChild(i)
							}
							e.tr.appendChild(t);
							...
							e.menu = o,
								...
								o.title = "Click to open the actions menu (Ctrl+M)",
								n.appendChild(e.menu),
								e.tr.appendChild(n)
						}
						var r = document.createElement("td");
						return e.tr.appendChild(r),
							e.tree = this._createDomTree(),
							r.appendChild(e.tree),
							this.updateDom({
								updateIndexes: !0
							}),
							e.tr
					...
					n.onDragStart = function(e, t) {
						if (!Array.isArray(e))
							return n.onDragStart([e], t);
						if (0 !== e.length) {
							var i = e[0]
								, o = e[e.length - 1]
								, r = n.getNodeFromTarget(t.target)
								, a = o._nextSibling()
								, l = i.editor
								, c = s.getAbsoluteTop(r.dom.tr) - s.getAbsoluteTop(i.dom.tr);
					...
					n.onDrag = function(e, t) {
						if (!Array.isArray(e))
							return n.onDrag([e], t);
						if (0 !== e.length) {
							var i, o, r, l, c, h, d, u, f, g, p, m, v, w, A = e[0].editor, C = t.pageY - A.drag.offsetY, E = t.pageX, y = !1, b = e[0];
							if (i = b.dom.tr,
									f = s.getAbsoluteTop(i),
									m = i.offsetHeight,
								f > C) {
								o = i;
								do
									o = o.previousSibling,
										d = n.getNodeFromTarget(o),
										g = o ? s.getAbsoluteTop(o) : 0;
								while (o && g > C);d && !d.parent && (d = void 0),
								d || (h = i.parentNode.firstChild,
									o = h ? h.nextSibling : void 0,
									d = n.getNodeFromTarget(o),
								d == b && (d = void 0)),
								d && (o = d.dom.tr,
									g = o ? s.getAbsoluteTop(o) : 0,
								...
								var F = e[e.length - 1];
								if (c = F.expanded && F.append ? F.append.getDom() : F.dom.tr,
										l = c ? c.nextSibling : void 0) {
									p = s.getAbsoluteTop(l),
										r = l;
									do
										u = n.getNodeFromTarget(r),
										r && (v = r.nextSibling ? s.getAbsoluteTop(r.nextSibling) : 0,
											w = r ? v - p : 0,
										u.parent.childs.length == e.length && u.parent.childs[e.length - 1] == F && (f += 27)),
											r = r.nextSibling;
									while (r && C > f + w);if (u && u.parent) {
										var x = E - A.drag.mouseX
											, S = Math.round(x / 24 / 2)
											, D = A.drag.level + S
											, $ = u.getLevel();
										for (o = u.dom.tr.previousSibling; D > $ && o; ) {
											d = n.getNodeFromTarget(o);
											var B = e.some(function(e) {
											...
											if (B)
												...
												if (!(d instanceof a))
													break;
												var k = d.parent.childs;
												if (k.length == e.length && k[e.length - 1] == F)
													break;
												u = n.getNodeFromTarget(o),
													$ = u.getLevel()
											}
											o = o.previousSibling
										}
					...
					n.onDragEnd = function(e, t) {
						...
						if (0 !== e.length) {
							var i = e[0]
								, o = i.editor
								, r = i.parent
								, a = r.childs.indexOf(i)
								, l = r.childs[a + e.length] || r.append;
							...
							c.oldBeforeNode != c.newBeforeNode && o._onAction("moveNodes", c),
								document.body.style.cursor = o.drag.oldCursor,
								o.highlighter.unlock(),
								e.forEach(function(e) {
										t.target !== e.dom.drag && t.target !== e.dom.menu && o.highlighter.unhighlight()
									}
								),
								delete o.drag,
							o.mousemove && (s.removeEventListener(window, "mousemove", o.mousemove),
								delete o.mousemove),
							o.mouseup && (s.removeEventListener(window, "mouseup", o.mouseup),
								delete o.mouseup),
								o.stopAutoScroll(),
								t.preventDefault()
						}
					...
					n.prototype.setHighlight = function(e) {
						this.dom.tr && (e ? s.addClassName(this.dom.tr, "jsoneditor-highlight") : s.removeClassName(this.dom.tr, "jsoneditor-highlight"),
						this.append && this.append.setHighlight(e),
					...
					n.prototype.setSelected = function(e, t) {
						this.selected = e,
						this.dom.tr && (e ? s.addClassName(this.dom.tr, "jsoneditor-selected") : s.removeClassName(this.dom.tr, "jsoneditor-selected"),
							t ? s.addClassName(this.dom.tr, "jsoneditor-first") : s.removeClassName(this.dom.tr, "jsoneditor-first"),
						this.append && this.append.setSelected(e),
						this.childs && this.childs.forEach(function(t) {
								t.setSelected(e)
							}
						))
					...
					n.prototype.updateDom = function(e) {
						...
						if (i) {
							this.fieldEditable ? (i.contentEditable = this.editable.field,
								i.spellcheck = !1,
								i.className = "jsoneditor-field") : i.className = "jsoneditor-readonly";
							var n;
							n = void 0 != this.index ? this.index : void 0 != this.field ? this.field : this._hasChilds() ? this.type : "",
								i.innerHTML = this._escapeHTML(n)
						}
						var o = this.dom.value;
						if (o) {
							var r = this.childs ? this.childs.length : 0;
							"array" == this.type ? (o.innerHTML = "[" + r + "]",
								s.addClassName(this.dom.tr, "jsoneditor-expandable")) : "object" == this.type ? (o.innerHTML = "{" + r + "}",
								s.addClassName(this.dom.tr, "jsoneditor-expandable")) : (o.innerHTML = this._escapeHTML(this.value),
								s.removeClassName(this.dom.tr, "jsoneditor-expandable"))
						}
						this._updateDomField(),
							this._updateDomValue(),
						e && e.updateIndexes === !0 && this._updateDomIndexes(),
						e && e.recurse === !0 && this.childs && this.childs.forEach(function(t) {
								t.updateDom(e)
							}
						),
					...
					n.prototype._createDomValue = function() {
						var e;
						return "array" == this.type ? (e = document.createElement("div"),
							e.innerHTML = "[...]") : "object" == this.type ? (e = document.createElement("div"),
							e.innerHTML = "{...}") : !this.editable.value && s.isUrl(this.value) ? (e = document.createElement("a"),
							e.href = this.value,
							e.target = "_blank",
							e.innerHTML = this._escapeHTML(this.value)) : (e = document.createElement("div"),
							e.contentEditable = this.editable.value,
							e.spellcheck = !1,
					...
					n.prototype._createDomExpandButton = function() {
						...
						return this._hasChilds() ? (e.className = this.expanded ? "jsoneditor-expanded" : "jsoneditor-collapsed",
							e.title = "Click to expand/collapse this field (Ctrl+E). \nCtrl+Click to expand/collapse including all childs.") : (e.className = "jsoneditor-invisible",
							e.title = ""),
							e
					}
					,
					n.prototype._createDomTree = function() {
						...
						o.className = "jsoneditor-tree",
							...
							o.appendChild(e.expand),
							e.tdExpand = o;
						var r = document.createElement("td");
						r.className = "jsoneditor-tree",
							n.appendChild(r),
							e.field = this._createDomField(),
							r.appendChild(e.field),
							e.tdField = r;
						var s = document.createElement("td");
						s.className = "jsoneditor-tree",
							n.appendChild(s),
						"object" != this.type && "array" != this.type && (s.appendChild(document.createTextNode(":")),
							s.className = "jsoneditor-separator"),
							e.tdSeparator = s;
						var a = document.createElement("td");
						return a.className = "jsoneditor-tree",
							n.appendChild(a),
							e.value = this._createDomValue(),
							a.appendChild(e.value),
							e.tdValue = a,
							t
					}
					,
					n.prototype.onEvent = function(e) {
						var t, i = e.type, n = e.target || e.srcElement, o = this.dom, r = this, a = this._hasChilds();
						if ((n == o.drag || n == o.menu) && ("mouseover" == i ? this.editor.highlighter.highlight(this) : "mouseout" == i && this.editor.highlighter.unhighlight()),
							"click" == i && n == o.menu) {
							var l = r.editor.highlighter;
							l.highlight(r),
								l.lock(),
								s.addClassName(o.menu, "jsoneditor-selected"),
								this.showContextMenu(o.menu, function() {
										s.removeClassName(o.menu, "jsoneditor-selected"),
											l.unlock(),
											l.unhighlight()
									}
								)
						}
						if ("click" == i && (n == o.expand || ("view" === r.editor.options.mode || "form" === r.editor.options.mode) && "DIV" === n.nodeName) && a) {
							var c = e.ctrlKey;
							this._onExpand(c)
						}
						var h = o.value;
						if (n == h)
							switch (i) {
								...
								case "change":
									this._getDomValue(!0),
										this._updateDomValue(),
									this.value && (h.innerHTML = this._escapeHTML(this.value));
									break;
								case "input":
									this._getDomValue(!0),
										this._updateDomValue();
						...
						if (n == d)
							switch (i) {
								...
								case "change":
									this._getDomField(!0),
										this._updateDomField(),
									this.field && (d.innerHTML = this._escapeHTML(this.field));
									break;
								case "input":
									this._getDomField(!0),
										this._updateDomField();
						...
						if (n == u.parentNode && "click" == i && !e.hasMoved) {
							var f = void 0 != e.offsetX ? e.offsetX < 24 * (this.getLevel() + 1) : e.pageX < s.getAbsoluteLeft(o.tdSeparator);
							f || a ? d && (s.setEndOfContentEditable(d),
								d.focus()) : h && (s.setEndOfContentEditable(h),
								h.focus())
						}
						(n != o.tdExpand || a) && n != o.tdField && n != o.tdSeparator || "click" != i || e.hasMoved || d && (s.setEndOfContentEditable(d),
							d.focus()),
						"keydown" == i && this.onKeyDown(e)
					}
					,
					n.prototype.onKeyDown = function(e) {
						var t, i, o, r, l, c, h, d, u = e.which || e.keyCode, f = e.target || e.srcElement, g = e.ctrlKey, p = e.shiftKey, m = e.altKey, v = !1, w = "tree" === this.editor.options.mode, A = this.editor.multiselection.nodes.length > 0 ? this.editor.multiselection.nodes : [this], C = A[0], E = A[A.length - 1];
						if (13 == u) {
							if (f == this.dom.value)
								(!this.editable.value || e.ctrlKey) && s.isUrl(this.value) && (window.open(this.value, "_blank"),
									v = !0);
							else if (f == this.dom.expand) {
								var y = this._hasChilds();
								if (y) {
									var b = e.ctrlKey;
									this._onExpand(b),
										f.focus(),
							...
							g && (this.showContextMenu(f),
								v = !0);
						else if (46 == u && w)
							g && (n.onRemove(A),
								v = !0);
						else if (45 == u && w)
							g && !p ? (this._onInsertBefore(),
								v = !0) : g && p && (this._onInsertAfter(),
								v = !0);
						else if (35 == u) {
							if (m) {
								var F = this._lastNode();
								F && F.focus(n.focusElement || this._getElementName(f)),
									v = !0
							}
						} else if (36 == u) {
							if (m) {
								var x = this._firstNode();
								x && x.focus(n.focusElement || this._getElementName(f)),
									v = !0
							}
						} else if (37 == u) {
							if (m && !p) {
								var S = this._previousElement(f);
								S && this.focus(this._getElementName(S)),
									v = !0
							} else if (m && p && w) {
								if (E.expanded) {
									var D = E.getAppend();
								...
								o && (i = n.getNodeFromTarget(o),
									r = o.nextSibling,
									_ = n.getNodeFromTarget(r),
								i && i instanceof a && 1 != E.parent.childs.length && _ && _.parent && (l = this.editor.getSelection(),
									c = E._nextSibling(),
									A.forEach(function(e) {
											_.parent.moveBefore(e, _)
										}
									),
									this.focus(n.focusElement || this._getElementName(f)),
							...
							m && !p ? (t = this._previousNode(),
							t && (this.editor.deselect(!0),
								t.focus(n.focusElement || this._getElementName(f))),
								v = !0) : !m && p && w ? (t = this._previousNode(),
							t && (d = this.editor.multiselection,
								d.start = d.start || this,
								d.end = t,
								h = this.editor._findTopLevelNodes(d.start, d.end),
								this.editor.select(h),
								t.focus("field")),
								v = !0) : m && p && w && (t = C._previousNode(),
							t && t.parent && (l = this.editor.getSelection(),
								c = E._nextSibling(),
								A.forEach(function(e) {
							...
							if (m && !p) {
								var B = this._nextElement(f);
								B && this.focus(this._getElementName(B)),
									v = !0
							} else if (m && p && w) {
								$ = C.getDom();
								var k = $.previousSibling;
								k && (t = n.getNodeFromTarget(k),
								t && t.parent && t instanceof a && !t.isVisible() && (l = this.editor.getSelection(),
									c = E._nextSibling(),
									A.forEach(function(e) {
											t.parent.moveBefore(e, t)
										}
							...
							if (m && !p)
								i = this._nextNode(),
								i && (this.editor.deselect(!0),
									i.focus(n.focusElement || this._getElementName(f))),
									v = !0;
							else if (!m && p && w)
								i = this._nextNode(),
								i && (d = this.editor.multiselection,
									d.start = d.start || this,
									d.end = i,
									h = this.editor._findTopLevelNodes(d.start, d.end),
									this.editor.select(h),
								...
								_ && _.parent && (l = this.editor.getSelection(),
									c = E._nextSibling(),
									A.forEach(function(e) {
											_.parent.moveBefore(e, _)
										}
					...
					n.prototype._onSort = function(e) {
						if (this._hasChilds()) {
							var t = "desc" == e ? -1 : 1
								, i = "array" == this.type ? "value" : "field";
							this.hideChilds();
							var n = this.childs
								, o = this.sort;
							this.childs = this.childs.concat(),
								this.childs.sort(function(e, n) {
					...
					n.prototype.getAppend = function() {
						return this.append || (this.append = new a(this.editor),
					...
					n.blurNodes = function(e) {
						if (!Array.isArray(e))
							return void n.blurNodes([e]);
						var t = e[0]
							, i = t.parent
							, o = t.getIndex();
						i.childs[o + e.length] ? i.childs[o + e.length].focus() : i.childs[o - 1] ? i.childs[o - 1].focus() : i.focus()
					}
					,
					...
					n.prototype._previousNode = function() {
						...
						if (t && t.parentNode) {
							...
							while (i && e instanceof a && !e.isVisible())
						}
						return e
					}
					,
					...
					n.prototype._lastNode = function() {
						...
						if (t && t.parentNode) {
							...
							for (e = n.getNodeFromTarget(i); i && e instanceof a && !e.isVisible(); )
								i = i.previousSibling,
									e = n.getNodeFromTarget(i)
						}
						return e
					...
					n.prototype._escapeHTML = function(e) {
						...
						return this.editor.options.escapeUnicode === !0 && (n = s.escapeUnicodeChars(n)),
							n
					}
					,
			...
			, function(e, t, i) {
				function n(e, t, i) {
					...
					for (var r = {
						...
						c.className = "jsoneditor-type-modes" + (i == l ? " jsoneditor-selected" : ""),
							s.push(c)
					}
					var h = r[i];
					if (!h)
					...
					u.className = "jsoneditor-modes jsoneditor-separator",
						u.innerHTML = d + " &#x25BE;",
						u.title = "Switch editor mode",
						u.onclick = function() {
							var e = new o(s);
							e.show(u)
						}
					...
					return f.className = "jsoneditor-modes",
				...
				var n = function() {
					var e = {
							...
							parse: function(e) {
								...
								for (var p, m, v, w, A, C, E, y, b, F = {}; ; ) {
									if (v = o[o.length - 1],
											this.defaultActions[v] ? w = this.defaultActions[v] : (null  == p && (p = i()),
												w = a[v] && a[v][p]),
										"undefined" == typeof w || !w.length || !w[0]) {
										if (!d) {
											b = [];
											for (C in a[v])
												this.terminals_[C] && C > 2 && b.push("'" + this.terminals_[C] + "'");
											var x = "";
											x = this.lexer.showPosition ? "Parse error on line " + (c + 1) + ":\n" + this.lexer.showPosition() + "\nExpecting " + b.join(", ") + ", got '" + this.terminals_[p] + "'" : "Parse error on line " + (c + 1) + ": Unexpected " + (1 == p ? "end of input" : "'" + (this.terminals_[p] || p) + "'"),
												this.parseError(x, {
									...
									switch (w[0]) {
										...
										case 2:
											if (E = this.productions_[w[1]][1],
													...
													A = this.performAction.call(F, l, h, c, this.yy, w[1], r, s),
												"undefined" != typeof A)
												return A;
											E && (o = o.slice(0, -1 * E * 2),
												r = r.slice(0, -1 * E),
						...
						, t = function() {
							var e = {
								...
								unput: function(e) {
									return this._input = e + this._input,
										this
								},
								more: function() {
									return this._more = !0,
								...
								next: function() {
									...
									this._more || (this.yytext = "",
										this.match = "");
									for (var r = this._currentRules(), s = 0; s < r.length && (i = this._input.match(this.rules[r[s]]),
									...
									this.done && this._input && (this.done = !1),
										e ? e : void 0) : "" === this._input ? this.EOF : void this.parseError("Lexical error on line " + (this.yylineno + 1) + ". Unrecognized text.\n" + this.showPosition(), {
										text: "",
										token: null ,
										line: this.yylineno
									})
					...
					return t.prototype = new e,
						t.prototype.getDom = function() {
							...
							if (t.node = this,
								...
								e.tdMenu = i;
								var n = document.createElement("button");
								n.className = "jsoneditor-contextmenu",
									n.title = "Click to open the actions menu (Ctrl+M)",
									e.menu = n,
									i.appendChild(e.menu)
							}
							var o = document.createElement("td")
								, r = document.createElement("div");
							return r.innerHTML = "(empty)",
								r.className = "jsoneditor-readonly",
								o.appendChild(r),
								e.td = o,
								e.text = r,
								this.updateDom(),
						...
						t.prototype.updateDom = function() {
							...
							var n = e.tr;
							this.isVisible() ? e.tr.firstChild || (e.tdDrag && n.appendChild(e.tdDrag),
							e.tdMenu && n.appendChild(e.tdMenu),
								n.appendChild(t)) : e.tr.firstChild && (e.tdDrag && n.removeChild(e.tdDrag),
							e.tdMenu && n.removeChild(e.tdMenu),
								n.removeChild(t))
						}
						,
						...
						t.prototype.onEvent = function(e) {
							var t = e.type
								...
								, n = this.dom
								, r = n.menu;
							if (i == r && ("mouseover" == t ? this.editor.highlighter.highlight(this.parent) : "mouseout" == t && this.editor.highlighter.unhighlight()),
								"click" == t && i == n.menu) {
								var s = this.editor.highlighter;
								s.highlight(this.parent),
									s.lock(),
									o.addClassName(n.menu, "jsoneditor-selected"),
									this.showContextMenu(n.menu, function() {
											o.removeClassName(n.menu, "jsoneditor-selected"),
												s.unlock(),
												s.unhighlight()
										}
									)
			...
			, function(e, t, i) {
				!function() {
					function e(e) {
						...
						t.define && t.define.packaged || (n.original = t.define,
							t.define = n,
							t.define.packaged = !0),
						t.acequire && t.acequire.packaged || (r.original = t.acequire,
							t.acequire = r,
							t.acequire.packaged = !0)
					}
					var t = "ace"
						, i = function() {
							return this
				...
				(),
					ace.define("ace/lib/regexp", ["require", "exports", "module"], function(e, t, i) {
							...
							a && s || (RegExp.prototype.exec = function(e) {
								...
								if ("string" == typeof e && l) {
									if (!s && l.length > 1 && o(l, "") > -1 && (i = RegExp(this.source, r.replace.call(n(this), "g", "")),
										...
										for (var c = 1; c < l.length; c++)
											t = this._xregexp.captureNames[c - 1],
											t && (l[t] = l[c]);
					...
					ace.define("ace/lib/es5-shim", ["require", "exports", "module"], function(e, t, i) {
									...
									var i = g.call(arguments, 1)
										, o = function() {
											if (this instanceof o) {
												var n = t.apply(this, i.concat(g.call(arguments)));
							...
							var s, a, l, c, h, d = Function.prototype.call, u = Array.prototype, f = Object.prototype, g = u.slice, p = d.bind(f.toString), m = d.bind(f.hasOwnProperty);
							if ((h = m(f, "__defineGetter__")) && (s = d.bind(f.__defineGetter__),
									a = d.bind(f.__defineSetter__),
									l = d.bind(f.__lookupGetter__),
									c = d.bind(f.__lookupSetter__)),
							...
							if (Array.prototype.forEach || (Array.prototype.forEach = function(e) {
										var t = O(this)
											, i = A && "[object String]" == p(this) ? this.split("") : t
											, n = arguments[1]
											, o = -1
											, r = i.length >>> 0;
								...
								Array.prototype.filter || (Array.prototype.filter = function(e) {
										var t, i = O(this), n = A && "[object String]" == p(this) ? this.split("") : i, o = n.length >>> 0, r = [], s = arguments[1];
										if ("[object Function]" != p(e))
											throw new TypeError(e + " is not a function");
										for (var a = 0; o > a; a++)
											a in n && (t = n[a],
											e.call(s, t, a, i) && r.push(t));
										return r
									}
								),
								...
								Array.prototype.indexOf && -1 == [0, 1].indexOf(1, 2) || (Array.prototype.indexOf = function(e) {
										var t = A && "[object String]" == p(this) ? this.split("") : O(this)
											, i = t.length >>> 0;
										if (!i)
											return -1;
										var n = 0;
										for (arguments.length > 1 && (n = r(arguments[1])),
												 n = n >= 0 ? n : Math.max(0, i + n); i > n; n++)
											if (n in t && t[n] === e)
												return n;
										return -1
									}
								...
								Array.prototype.lastIndexOf && -1 == [0, 1].lastIndexOf(0, -3) || (Array.prototype.lastIndexOf = function(e) {
										...
										if (!i)
											return -1;
										var n = i - 1;
										for (arguments.length > 1 && (n = Math.min(n, r(arguments[1]))),
							...
							if (Object.defineProperty) {
								var y = o({})
									, b = "undefined" == typeof document || o(document.createElement("div"));
								if (!y || !b)
							...
							Object.defineProperties || (Object.defineProperties = function(e, t) {
									for (var i in t)
										m(t, i) && Object.defineProperty(e, i, t[i]);
									return e
								}
							),
					...
					ace.define("ace/lib/dom", ["require", "exports", "module"], function(e, t, i) {
							...
							return t.getDocumentHead = function(e) {
								...
								t.importCssString = function(e, i, n) {
									...
									var o;
									i && (e += "\n/*# sourceURL=ace/css/" + i + " */"),
										n.createStyleSheet ? (o = n.createStyleSheet(),
											o.cssText = e,
										i && (o.owningElement.id = i)) : (o = t.createElement("style"),
											o.appendChild(n.createTextNode(e)),
										i && (o.id = i),
											t.getDocumentHead(n).appendChild(o))
								}
								,
					...
					ace.define("ace/lib/useragent", ["require", "exports", "module"], function(e, t, i) {
							...
							if (t.OS = {
								...
								t.isWin = "win" == n,
									t.isMac = "mac" == n,
									t.isLinux = "linux" == n,
									t.isIE = "Microsoft Internet Explorer" == navigator.appName || navigator.appName.indexOf("MSAppHost") >= 0 ? parseFloat((o.match(/(?:MSIE |Trident\/[0-9]+[\.0-9]+;.*rv:)([0-9]+[\.0-9]+)/) || [])[1]) : parseFloat((o.match(/(?:Trident\/[0-9]+[\.0-9]+;.*rv:)([0-9]+[\.0-9]+)/) || [])[1]),
									t.isOldIE = t.isIE && t.isIE < 9,
									t.isGecko = t.isMozilla = (window.Controllers || window.controllers) && "Gecko" === window.navigator.product,
									t.isOldGecko = t.isGecko && parseInt((o.match(/rv\:(\d+)/) || [])[1], 10) < 4,
							...
							t.addListener = function(e, t, i) {
								...
								t.addMultiMouseDownListener = function(e, i, n, o) {
									...
									t.addListener(e, "mousedown", function(e) {
											if (0 !== t.getButton(e) ? c = 0 : e.detail > 1 ? (c++,
												c > 4 && (c = 1)) : c = 1,
													s.isIE) {
									...
									t.addCommandKeyListener = function(e, i) {
										...
										if (s.isOldGecko || s.isOpera && !("KeyboardEvent" in window)) {
											...
											r(e, "keydown", function(e) {
													var t = e.keyCode;
													a[t] = (a[t] || 0) + 1,
														91 == t || 92 == t ? a.OSKey = !0 : a.OSKey && e.timeStamp - a.lastT > 200 && 1 == a.count && o(),
													1 == a[t] && a.count++,
														a.lastT = e.timeStamp;
													var r = n(i, e, t);
												...
												r(e, "keyup", function(e) {
														var t = e.keyCode;
														a[t] ? a.count = Math.max(a.count - 1, 0) : o(),
														(91 == t || 92 == t) && (a.OSKey = !1),
															a[t] = null
													}
												),
								...
								, c = function(e, t) {
									...
									n.addListener(d, "blur", function(e) {
										...
										this.focus = function() {
											...
											d.style.position = "fixed",
												...
												setTimeout(function() {
														d.style.position = "",
														"-1000px" == d.style.top && (d.style.top = e)
													}
													, 0)
										}
										,
									...
									if (!d.setSelectionRange && d.createTextRange && (d.setSelectionRange = function(e, t) {
										...
										n.addListener(d, "keyup", function(e) {
												return !p || d.value && !S[e.keyCode] || setTimeout(j, 0),
													(d.value.charCodeAt(0) || 0) < 129 ? x.call() : void (p ? I() : N())
											}
										),
									...
									var D = function(e) {
											f ? f = !1 : y(d) ? (t.selectAll(),
												i()) : $ && i(t.selection.isEmpty())
										}
										, $ = null ;
									...
									var B = !1
										, k = function(e) {
											$ && (e = $(e),
												...
												g ? (i(),
												e && t.onPaste(e),
													g = !1) : e == u.charAt(0) ? B ? t.execCommand("del", {
													source: "ace"
										...
										, R = function(e, o) {
											var r = t.getCopyText();
											return r ? void (L(e, r) ? (o ? t.onCut() : t.onCopy(),
												n.preventDefault(e)) : (f = !0,
												d.value = r,
												d.select(),
												setTimeout(function() {
														f = !1,
										...
										, O = function(e) {
											...
											o.isIE && setTimeout(i),
												n.preventDefault(e)) : (d.value = "",
												g = !0)
										}
										;
									n.addCommandKeyListener(d, t.onCommandKey.bind(t)),
										n.addListener(d, "select", D),
										n.addListener(d, "input", _),
										n.addListener(d, "cut", T),
										n.addListener(d, "copy", M),
										n.addListener(d, "paste", O),
									"oncut" in d && "oncopy" in d && "onpaste" in d || n.addListener(e, "keydown", function(e) {
									...
									var N = function(e) {
											p || !t.onCompositionStart || t.$readOnly || (p = {},
										...
										, I = function() {
											if (p && t.onCompositionUpdate && !t.$readOnly) {
												...
												if (p.lastValue !== e && (t.onCompositionUpdate(e),
													p.lastValue && t.undo(),
														p.lastValue = e,
														p.lastValue)) {
													var i = t.selection.getRange();
													t.insert(p.lastValue),
														t.session.markUndoGroup(),
														p.range = t.selection.getRange(),
										...
										, j = function(e) {
											if (t.onCompositionEnd && !t.$readOnly) {
												...
												var n = setTimeout(function() {
														n = null ;
														var e = d.value.replace(/\x01/g, "");
														p || (e == i.lastValue ? c() : !i.lastValue && e && (c(),
															k(e)))
													}
												);
												$ = function(e) {
													...
													,
													t.onCompositionEnd(),
													t.removeListener("mousedown", j),
												"compositionend" == e.type && i.range && t.selection.setRange(i.range)
											}
										}
										, P = s.delayedCall(I, 50);
									n.addListener(d, "compositionstart", N),
										o.isGecko ? n.addListener(d, "text", function() {
												P.schedule()
											}
										...
										n.addListener(d, "compositionend", j),
										...
										this.moveToMouse = function(e, i) {
											if (i || !o.isOldIE) {
												m || (m = d.style.cssText),
													d.style.cssText = (i ? "z-index:100000;" : "") + "height:" + d.style.height + ";" + (o.isIE ? "opacity:0.1;" : "");
												...
												o.isWin && !o.isOldIE && n.capture(t.container, f, h))
											}
										}
										,
									...
									var W, H = function(e) {
										...
										;
									n.addListener(t.renderer.scroller, "contextmenu", H),
										n.addListener(d, "contextmenu", H)
								}
								;
							t.TextInput = c
						}
							...
							(function() {
									this.onMouseDown = function(e) {
										...
										if (0 !== o) {
											...
											s && n.selection.moveToPosition(i),
												n.$blockScrolling--,
										...
										this.onDoubleClick = function(e) {
											...
											o ? (o.isEmpty() && (o.start.column--,
												o.end.column++),
												this.setState("select")) : (o = i.selection.getWordRange(t.row, t.column),
										...
										this.onMouseWheel = function(e) {
											if (!e.getAccelKey()) {
												...
												return o || 200 > i ? (this.$lastScrollTime = t,
					...
					ace.define("ace/tooltip", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom"], function(e, t, i) {
							...
							(function() {
									this.$init = function() {
										return this.$element = o.createElement("div"),
										...
										this.setText = function(e) {
											o.setInnerText(this.getElement(), e)
										}
										,
										...
										this.setClassName = function(e) {
											o.addCssClass(this.getElement(), e)
										}
										,
					...
					ace.define("ace/mouse/default_gutter_handler", ["require", "exports", "module", "ace/lib/dom", "ace/lib/oop", "ace/lib/event", "ace/tooltip"], function(e, t, i) {
							...
							function n(e) {
								function t() {
									...
									if (t == r) {
										var a = s.renderer.pixelToScreenCoordinates(0, d.y).row
											, h = d.$pos;
										if (a > s.session.documentToScreenRow(h.row, h.column))
											return i()
									}
									if (u != o)
										if (u = o.text.join("<br/>"),
								...
								function i() {
									...
									u && (c.hide(),
										u = null ,
										s.removeEventListener("mousewheel", i))
								}
								function n(e) {
								...
								e.editor.setDefaultHandler("guttermousemove", function(o) {
										...
										return r.hasCssClass(s, "ace_fold-widget") ? i() : (u && e.$tooltipFollowsMouse && n(o),
											d = o,
							...
							function n(e) {
								function t(e, t) {
									...
									if (!$ || n || r)
										...
										var s = o(B.x, B.y, C, E);
										s > h ? $ = null  : i - $ >= c && (m.renderer.scrollCursorIntoView(),
											$ = null )
									}
								}
								function i(e, t) {
									var i = Date.now()
										, n = m.renderer.layerConfig.lineHeight
										, o = m.renderer.layerConfig.characterWidth
									...
									2 >= a / o && (h.column += s.x.left < s.x.right ? -3 : 2),
									1 >= c / n && (h.row += s.y.top < s.y.bottom ? -1 : 1);
									var d = e.row != h.row
										, u = e.column != h.column
										, f = !t || e.row != t.row;
									d || u && !f ? D ? i - D >= l && m.renderer.scrollCursorIntoView(h) : D = i : D = null
								}
								function n() {
									var e = F;
									F = m.renderer.screenToTextCoordinates(C, E),
										t(F, e),
										i(F, e)
								}
								function d() {
								...
								function u() {
									clearInterval(y),
										...
										m.$blockScrolling -= 1,
									m.isFocused() && !S && m.renderer.$cursorLayer.setBlinking(!m.getReadOnly()),
										b = null ,
										F = null ,
										_ = 0,
										D = null ,
								...
								function p(e) {
									...
									var r = "none";
									return n && t.indexOf(o) >= 0 ? r = "copy" : i.indexOf(o) >= 0 ? r = "move" : t.indexOf(o) >= 0 && (r = "copy"),
										r
								}
								var m = e.editor
								...
								var A, C, E, y, b, F, x, S, D, $, B, k = m.container, _ = 0;
								this.onDragStart = function(e) {
									...
									this.onDragEnd = function(e) {
										if (k.draggable = !1,
											...
											x || "move" != t || m.session.remove(m.getSelectionRange()),
									...
									this.onDragEnter = function(e) {
										return !m.getReadOnly() && g(e.dataTransfer) ? (C = e.clientX,
											E = e.clientY,
										A || d(),
											_++,
											e.dataTransfer.dropEffect = x = p(e),
											s.preventDefault(e)) : void 0
									}
									,
									...
									,
									s.addListener(k, "dragstart", this.onDragStart.bind(e)),
									s.addListener(k, "dragend", this.onDragEnd.bind(e)),
									s.addListener(k, "dragenter", this.onDragEnter.bind(e)),
									s.addListener(k, "dragover", this.onDragOver.bind(e)),
									s.addListener(k, "dragleave", this.onDragLeave.bind(e)),
									s.addListener(k, "drop", this.onDrop.bind(e));
								var L = null
							}
							function o(e, t, i, n) {
								return Math.sqrt(Math.pow(i - e, 2) + Math.pow(n - t, 2))
									...
									this.dragWait = function() {
										...
										this.onMouseDrag = function(e) {
											...
											if (a.isIE && "dragReady" == this.state) {
												var i = o(this.mousedownEvent.x, this.mousedownEvent.y, this.x, this.y);
												i > 3 && t.dragDrop()
											}
					...
					ace.define("ace/config", ["require", "exports", "module", "ace/lib/lang", "ace/lib/oop", "ace/lib/net", "ace/lib/app_config"], function(e, t, n) {
							"no use strict";
							function o(o) {
								if (h.packaged = o || e.packaged || n.packaged || c.define && i(18).packaged,
										!c.document)
									return "";
								for (var s = {}, a = "", l = document.currentScript || document._currentScript, d = l && l.ownerDocument || document, u = d.getElementsByTagName("script"), f = 0; f < u.length; f++) {
									...
									if (p) {
										for (var m = g.attributes, v = 0, w = m.length; w > v; v++) {
											var A = m[v];
											0 === A.name.indexOf("data-ace-") && (s[r(A.name.replace(/^data-ace-/, ""))] = A.value)
										}
								...
								a && (s.base = s.base || a,
									...
									delete s.base;
								for (var E in s)
									"undefined" != typeof s[E] && t.set(E, s[E])
							}
							function r(e) {
							...
							t.get = function(e) {
								...
								t.moduleUrl = function(e, t) {
									...
									var s = h[t + "Path"];
									return null  == s ? s = h.basePath : "/" == n && (t = n = ""),
									s && "/" != s.slice(-1) && (s += "/"),
									s + t + n + o + this.get("suffix")
								}
								,
								...
								t.loadModule = function(i, n) {
									...
									if (t.$loading[i] || (t.$loading[i] = []),
										...
										var l = function() {
											...
											;
										return t.get("packaged") ? void a.loadScript(t.moduleUrl(i, r), l) : l()
									}
								}
								,
								o(!0),
					...
					ace.define("ace/mouse/mouse_handler", ["require", "exports", "module", "ace/lib/event", "ace/lib/useragent", "ace/mouse/default_handlers", "ace/mouse/default_gutter_handler", "ace/mouse/mouse_event", "ace/mouse/dragdrop_handler", "ace/config"], function(e, t, i) {
							...
							var n = e("../lib/event")
								...
								, h = function(e) {
									...
									this.editor = e,
										...
										new l(this);
									var i = function(t) {
											document.hasFocus && document.hasFocus() || window.focus(),
												e.focus(),
											e.isFocused() || window.focus()
										}
									...
									e.renderer.scrollBarV && (n.addMultiMouseDownListener(e.renderer.scrollBarV.inner, [400, 300, 250], this, "onMouseEvent"),
										n.addMultiMouseDownListener(e.renderer.scrollBarH.inner, [400, 300, 250], this, "onMouseEvent"),
									o.isIE && (n.addListener(e.renderer.scrollBarV.element, "mousedown", i),
										...
										e.on("mousemove", function(i) {
												if (!t.state && !t.$dragDelay && t.$dragEnabled) {
													var n = e.renderer.screenToTextCoordinates(i.x, i.y)
														...
														, r = e.renderer;
													!o.isEmpty() && o.insideStart(n.row, n.column) ? r.setCursorStyle("default") : r.setCursorStyle("")
												}
											}
										)
								}
							...
							(function() {
									this.onMouseEvent = function(e, t) {
										...
										this.captureMouse = function(e, t) {
											...
											var r = this
												, s = function(e) {
													if (e) {
														if (o.isWebKit && !e.which && r.releaseMouse)
												...
												;
											if (o.isOldIE && "dblclick" == e.domEvent.type)
												return setTimeout(function() {
														l(e)
													}
												);
											r.$onCaptureMouseMove = s,
												r.releaseMouse = n.capture(this.editor.container, s, l);
								...
								c.defineOptions(h.prototype, "mouseHandler", {
									scrollSpeed: {
										initialValue: 2
									},
									dragDelay: {
								...
								e.on("click", function(t) {
									...
									e.on("gutterclick", function(t) {
											...
											if ("foldWidgets" == i) {
												var n = t.getDocumentPosition().row
													, o = e.session;
												o.foldWidgets && o.foldWidgets[n] && e.session.onFoldWidgetClick(n, t),
												e.isFocused() || e.focus(),
													t.stop()
											}
										}
									...
									e.on("gutterdblclick", function(t) {
											...
											if ("foldWidgets" == i) {
												var n = t.getDocumentPosition().row
													, o = e.session
													, r = o.getParentFoldRangeData(n, !0)
													, s = r.range || r.firstRange;
												if (s) {
													n = s.start.row;
													var a = o.getFoldAt(n, o.getLine(n).length, 1);
													a ? o.removeFold(a) : (o.addFold("...", s),
							...
							(function() {
									this.setDefaultHandler = function(e) {
										...
										this.$callKeyboardHandlers = function(e, t, i, n) {
											for (var r, s = !1, a = this.$editor.commands, l = this.$handlers.length; l-- && (r = this.$handlers[l].handleKeyboard(this.$data, e, t, i, n),
												!(r && r.command && (s = "null" == r.command ? !0 : a.exec(r.command, this.$editor, r.args, n),
												s && n && -1 != e && 1 != r.passEvent && 1 != r.command.passEvent && o.stopEvent(n),
													s))); )
												;
											return s || -1 != e || (r = {
											...
											s && this.$editor._signal("keyboardActivity", r),
												s
										}
										,
							...
							(function() {
									this.isEqual = function(e) {
										...
										this.extend = function(e, t) {
											...
											return o.fromPoints(n || this.start, r || this.end)
										}
										,
									...
									n.implement(this, r),
										...
										this.getLineRange = function(e, t) {
											...
											return o ? (n = o.start.row,
												i = o.end.row) : i = n,
												t === !0 ? new s(n,0,i,this.session.getLine(i).length) : new s(n,0,i + 1,0)
										}
										,
										...
										this.moveCursorLineStart = function() {
											var e = this.lead.row
												...
												, r = o.match(/^\s*/);
											r[0].length == t || this.session.$useEmacsStyleLineStart || (n.column += r[0].length),
										...
										this.moveCursorLongWordRight = function() {
											...
											return r ? void this.moveCursorTo(r.end.row, r.end.column) : ((e = this.session.nonTokenRe.exec(o)) && (i += this.session.nonTokenRe.lastIndex,
												this.session.nonTokenRe.lastIndex = 0,
												o = n.substring(i)),
												i >= n.length ? (this.moveCursorTo(t, n.length),
													this.moveCursorRight(),
													void (t < this.doc.getLength() - 1 && this.moveCursorWordRight())) : ((e = this.session.tokenRe.exec(o)) && (i += this.session.tokenRe.lastIndex,
													this.session.tokenRe.lastIndex = 0),
										...
										this.moveCursorLongWordLeft = function() {
											...
											var r, s = o.stringReverse(n);
											return this.session.nonTokenRe.lastIndex = 0,
												this.session.tokenRe.lastIndex = 0,
											(r = this.session.nonTokenRe.exec(s)) && (i -= this.session.nonTokenRe.lastIndex,
												s = s.slice(this.session.nonTokenRe.lastIndex),
												this.session.nonTokenRe.lastIndex = 0),
												0 >= i ? (this.moveCursorTo(t, 0),
													this.moveCursorLeft(),
													void (t > 0 && this.moveCursorWordLeft())) : ((r = this.session.tokenRe.exec(s)) && (i -= this.session.tokenRe.lastIndex,
													this.session.tokenRe.lastIndex = 0),
													void this.moveCursorTo(t, i))
										}
										,
										...
										this.moveCursorShortWordLeft = function() {
											...
											if (0 === i) {
												...
												while (t > 0 && /^\s*$/.test(n));i = n.length,
												/\s+$/.test(n) || (n = "")
											}
											var r = o.stringReverse(n)
							...
							var n = e("./config")
								...
								, r = function(e) {
									...
									for (var t in this.states) {
										for (var i = this.states[t], n = [], o = 0, r = this.matchMappings[t] = {
											defaultToken: "text"
										}, s = "g", a = [], l = 0; l < i.length; l++) {
											var c = i[l];
											if (c.defaultToken && (r.defaultToken = c.defaultToken),
												...
												Array.isArray(c.token) ? 1 == c.token.length || 1 == d ? c.token = c.token[0] : d - 1 != c.token.length ? (this.reportError("number of classes and regexp groups doesn't match", {
													...
													c.token = null ,
													c.onMatch = this.$arrayTokens) : "function" != typeof c.token || c.onMatch || (d > 1 ? c.onMatch = this.$applyToken : c.onMatch = c.token),
							...
							(function() {
									this.$setMaxTokenCount = function(e) {
										...
										this.$arrayTokens = function(e) {
											...
											if (!t)
												return "text";
											for (var i = [], n = this.tokenArray, o = 0, r = n.length; r > o; o++)
												t[o + 1] && (i[i.length] = {
													type: n[o],
													value: t[o + 1]
												});
										...
										this.createSplitterRegexp = function(e, t) {
											if (-1 != e.indexOf("(?=")) {
												...
												e.replace(/(\\.)|(\((?:\?[=!])?)|(\))|([\[\]])/g, function(e, t, r, s, a, l) {
														return n ? n = "]" != a : a ? n = !0 : s ? (i == o.stack && (o.end = l + 1,
															o.stack = -1),
															i--) : r && (i++,
														1 != r.length && (o.stack = i,
															o.start = l)),
															e
													}
												),
										...
										this.getLineTokens = function(e, t) {
											...
											for (var l, c = [], h = 0, d = 0, u = {
												...
												if (m - p.length > h) {
													...
													u.type == f ? u.value += v : (u.type && c.push(u),
														u = {
															type: f,
															value: v
														})
												...
												for (var w = 0; w < l.length - 2; w++)
													if (void 0 !== l[w + 1]) {
														g = r[s[w]],
															f = g.onMatch ? g.onMatch(p, n, i) : g.token,
														g.next && (n = "string" == typeof g.next ? g.next : g.next(n, i),
															r = this.states[n],
														r || (this.reportError("state doesn't exist", n),
															n = "start",
															r = this.states[n]),
															s = this.matchMappings[n],
															h = m,
															a = this.regExps[n],
															a.lastIndex = m);
														break
												...
												if (p)
													if ("string" == typeof f)
														g && g.merge === !1 || u.type !== f ? (u.type && c.push(u),
															u = {
																type: f,
																value: p
															}) : u.value += p;
										...
										if (t)
											for (var i in e) {
												for (var n = e[i], o = 0; o < n.length; o++) {
													var r = n[o];
													(r.next || r.onMatch) && ("string" == typeof r.next && 0 !== r.next.indexOf(t) && (r.next = t + r.next),
													r.nextState && 0 !== r.nextState.indexOf(t) && (r.nextState = t + r.nextState))
												}
												this.$rules[t + i] = n
											}
										else
							...
							(function() {
									this.tokenRe = new RegExp("^[" + s.packages.L + s.packages.Mn + s.packages.Mc + s.packages.Nd + s.packages.Pc + "\\$_]+","g"),
										...
										this.toggleCommentLines = function(e, t, i, n) {
											...
											if (this.lineCommentStart) {
												if (Array.isArray(this.lineCommentStart))
													var u = this.lineCommentStart.map(a.escapeRegExp).join("|")
														, f = this.lineCommentStart[0];
												else
													var u = a.escapeRegExp(this.lineCommentStart)
												...
												var g = function(e, t) {
														...
														if (i) {
															var n = i[1].length
																, o = i[0].length;
															w(e, n, o) || " " != i[0][o - 1] || o--,
																r.removeInLine(t, n, o)
														}
													}
													, p = f + " "
													, m = function(e, t) {
														(!s || /\S/.test(e)) && (w(e, c, c) ? r.insertInLine({
															row: t,
															column: c
														}, p) : r.insertInLine({
															row: t,
												...
												var f = this.blockComment.start
													, A = this.blockComment.end
													, u = new RegExp("^(\\s*)(?:" + a.escapeRegExp(f) + ")")
													, C = new RegExp("(?:" + a.escapeRegExp(A) + ")\\s*$")
													, m = function(e, t) {
													...
													, g = function(e, t) {
														var i;
														(i = e.match(C)) && r.removeInLine(t, e.length - i[0].length, e.length),
														(i = e.match(u)) && r.removeInLine(t, i[1].length, i[0].length)
													}
													, v = function(e, i) {
														if (u.test(e))
															return !0;
											...
											o(function(e, t) {
													var i = e.search(/\S/);
													-1 !== i ? (c > i && (c = i),
													l && !v(e, t) && (l = !1)) : E > e.length && (E = e.length)
												}
											),
											c == 1 / 0 && (c = E,
												s = !1,
										...
										this.toggleBlockComment = function(e, t, i, n) {
											...
											if (o) {
												!o.start && o[0] && (o = o[0]);
												var r, s, a = new l(t,n.row,n.column), h = a.getCurrentToken(), d = (t.selection,
												...
												if (h && /comment/.test(h.type)) {
													for (var u, f; h && /comment/.test(h.type); ) {
														...
														if (-1 != g) {
															...
															u = new c(p,m,p,m + o.start.length);
															break
														}
														h = a.stepBackward()
													}
													...
													s = o.start.length,
														r = i.start.row,
														t.insert(i.end, o.end),
														t.insert(i.start, o.start);
												d.start.row == r && (d.start.column += s),
												d.end.row == r && (d.end.column += s),
							...
							t.applyDelta = function(e, t, i) {
								...
								switch (t.action) {
									case "insert":
										var s = t.lines;
										if (1 === s.length)
											e[n] = r.substring(0, o) + t.lines[0] + r.substring(o);
										else {
											var a = [n, 1].concat(t.lines);
											e.splice.apply(e, a),
												e[n] = r.substring(0, o) + e[n],
												e[n + t.lines.length - 1] += r.substring(o)
										}
										break;
									case "remove":
										var l = t.end.column
											, c = t.end.row;
										n === c ? e[n] = r.substring(0, o) + r.substring(l) : e.splice(n, c - n + 1, r.substring(0, o) + e[c].substring(l))
								}
							}
						}
					),
							...
							(function() {
									n.implement(this, r),
										...
										this.applyDelta = function(e, t) {
											...
											(i ? e.lines.length <= 1 && !e.lines[0] : !s.comparePoints(e.start, e.end)) || (i && e.lines.length > 2e4 && this.$splitAndapplyLargeDelta(e, 2e4),
												o(this.$lines, e, t),
												this._signal("change", e))
										}
										,
										this.$splitAndapplyLargeDelta = function(e, t) {
											for (var i = e.lines, n = i.length, o = e.start.row, r = e.start.column, s = 0, a = 0; ; ) {
												s = a,
													a += t - 1;
												var l = i.slice(s, a);
												if (a > n) {
							...
							var n = e("./lib/oop")
								...
								, r = function(e, t) {
									...
									this.$worker = function() {
										if (i.running) {
											for (var e = new Date, t = i.currentLine, n = -1, o = i.doc, r = t; i.lines[t]; )
												t++;
											var s = o.getLength()
												, a = 0;
											for (i.running = !1; s > t; ) {
											...
											if (this.regExp)
												for (var s = r.firstRow, a = r.lastRow, l = s; a >= l; l++) {
													...
													for (var h = c.length; h--; )
														t.drawSingleLineMarker(e, c[h].toScreenRange(i), this.clazz, r)
												}
										}
								}
							).call(r.prototype),
									...
									this.shiftRow = function(e) {
										...
										this.walk = function(e, t, i) {
											...
											for (var c = 0; c < a.length; c++) {
												if (n = a[c],
														o = n.range.compareStart(t, i),
													-1 == o)
													return void e(null , t, i, s, l);
												if (r = e(null , n.start.row, n.start.column, s, l),
														r = !r && e(n.placeholder, n.start.row, n.start.column, s),
													r || 0 === o)
													return;
												l = !n.sameRow,
													s = n.end.column
									...
									this.comparePoints = o,
										...
										this.merge = function() {
											...
											for (var i, n = t[0], r = 1; r < t.length; r++) {
												i = n,
													n = t[r];
												var s = o(i.end, n.start);
												0 > s || (0 != s || i.isEmpty() || n.isEmpty()) && (o(i.end, n.end) < 0 && (i.end.row = n.end.row,
										...
										this.$onChange = function(e) {
											if ("insert" == e.action)
												...
												var i = e.start
													, t = e.end;
											for (var n = t.row, o = i.row, r = o - n, s = -t.column + i.column, a = this.ranges, l = 0, c = a.length; c > l; l++) {
												var h = a[l];
												if (!(h.end.row < n)) {
													if (h.start.row > n)
														break;
													if (h.start.row == n && h.start.column >= t.column && (h.start.column == t.column && this.$insertRight || (h.start.column += s,
														...
														if (h.end.column == t.column && this.$insertRight)
															continue;h.end.column == t.column && s > 0 && c - 1 > l && h.end.column > h.start.column && h.end.column == a[l + 1].start.column && (h.end.column -= s),
															h.end.column += s,
															h.end.row += r
													}
												}
									...
									this.toString = function() {
										...
										this.addSubFold = function(e) {
											if (!this.range.isEqual(e)) {
												...
												o(e, this.start);
												for (var t = e.start.row, i = e.start.column, n = 0, r = -1; n < this.subFolds.length && (r = this.subFolds[n].range.compare(t, i),
												1 == r); n++)
													;
												var s = this.subFolds[n];
												if (0 == r)
													return s.addSubFold(e);
												for (var t = e.range.end.row, i = e.range.end.column, a = n, r = -1; a < this.subFolds.length && (r = this.subFolds[a].range.compare(t, i),
												1 == r); a++)
													;
												this.subFolds[a];
												if (0 == r)
							...
							function n() {
								this.getFoldAt = function(e, t, i) {
									...
									for (var o = n.folds, r = 0; r < o.length; r++) {
										...
										if (s.range.contains(e, t)) {
											if (1 == i && s.range.isEnd(e, t))
												continue;if (-1 == i && s.range.isStart(e, t))
												continue;return s
										}
									}
								}
									...
									this.getFoldStringAt = function(e, t, i, n) {
										...
										return o || (o = this.getLine(r.start.row).substring(s.end.column)),
											-1 == i ? o.substring(0, t - s.end.column) : 1 == i ? o.substring(t - s.end.column) : o
									}
									,
									...
									this.addFold = function(e, t) {
										...
										e instanceof s ? i = e : (i = new s(t,e),
										...
										return o || (p = this.$addFoldLine(new r(this.$foldData,i))),
									...
									this.removeFold = function(e) {
										...
										if (1 == r.length)
											...
											r = s.folds,
												r.shift(),
												s.start.row = r[0].start.row,
												s.start.column = r[0].start.column
										}
									...
									this.getDisplayLine = function(e, t, i, n) {
										...
										var r;
										return r = this.doc.getLine(e),
											r.substring(n || 0, t || r.length)
									}
									,
									...
									this.toggleFold = function(e) {
										...
										if (o.isEmpty()) {
											...
											(i = this.findMatchingBracket(r)) ? 1 == o.comparePoint(i) ? o.end = i : (o.start = i,
												o.start.column++,
												o.end.column--) : (i = this.findMatchingBracket({
												row: r.row,
												column: r.column + 1
											})) ? (1 == o.comparePoint(i) ? o.end = i : o.start = i,
												o.start.column++) : o = this.getCommentFoldRange(r.row, r.column) || o
										} else {
										...
										if (t || (t = this.getFoldAt(o.start.row, o.start.column)),
											t && t.range.toString() == o.toString())
											return void this.expandFold(t);
										var a = "...";
										if (!o.isMultiLine()) {
											if (a = this.getTextRange(o),
												a.length < 4)
												return;
									...
									this.getCommentFoldRange = function(e, t, i) {
										...
										if (r && /^comment|string/.test(r.type)) {
											...
											if (1 != i) {
												do
													r = n.stepBackward();
												while (r && l.test(r.type));n.stepForward()
											}
											if (s.start.row = n.getCurrentTokenRow(),
													s.start.column = n.getCurrentTokenColumn() + 2,
													n = new a(this,e,t),
												-1 != i) {
												do
													r = n.stepForward();
												while (r && l.test(r.type));r = n.stepBackward()
											} else
												r = n.getCurrentToken();
											return s.end.row = n.getCurrentTokenRow(),
												s.end.column = n.getCurrentTokenColumn() + r.value.length - 2,
												s
										}
									}
									,
									...
									this.getParentFoldRangeData = function(e, t) {
										...
										for (var n, o = e - 1; o >= 0; ) {
											var r = i[o];
											if (null  == r && (r = i[o] = this.getFoldWidget(o)),
												"start" == r) {
									...
									this.$toggleFoldWidget = function(e, t) {
										if (this.getFoldWidget) {
											var i = this.getFoldWidget(e)
												, n = this.getLine(e)
												, o = "end" === i ? -1 : 1
												, r = this.getFoldAt(e, -1 === o ? 0 : n.length, o);
											if (r)
									...
									this.toggleFoldWidget = function(e) {
										...
										if (!i) {
											...
											if (i = n.range || n.firstRange) {
												...
												o ? this.removeFold(o) : this.addFold("...", i)
											}
										}
									}
									,
					...
					ace.define("ace/edit_session", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/config", "ace/lib/event_emitter", "ace/selection", "ace/mode/text", "ace/range", "ace/document", "ace/background_tokenizer", "ace/search_highlight", "ace/edit_session/folding", "ace/edit_session/bracket_match"], function(e, t, i) {
							...
							(function() {
									...
									n.implement(this, s),
										...
										this.getTokenAt = function(e, t) {
											...
											if (null  == t)
												...
												for (var r = 0; r < n.length && (o += n[r].value.length,
													!(o >= t)); r++)
													;
											return (i = n[r]) ? (i.index = r,
												i.start = o - i.value.length,
												i) : null
										}
										,
										...
										this.addMarker = function(e, t, i, n) {
											...
											return n ? (this.$frontMarkers[o] = r,
												this._signal("changeFrontMarker")) : (this.$backMarkers[o] = r,
										...
										this.getWordRange = function(e, t) {
											...
											if (r > 0) {
												do
													r--;
												while (r >= 0 && i.charAt(r).match(o));r++
											}
										...
										this.setMode = function(e, t) {
											if (e && "object" == typeof e) {
												...
												n = e || "ace/mode/text";
											return this.$modes["ace/mode/text"] || (this.$modes["ace/mode/text"] = new l),
										...
										this.$getUndoSelection = function(e, t, i) {
											...
											var o, r, s = e[0], a = !1;
											n(s) ? (o = c.fromPoints(s.start, s.end),
												a = !0) : (o = c.fromPoints(s.start, s.start),
												a = !1);
											for (var l = 1; l < e.length; l++)
												s = e[l],
													n(s) ? (r = s.start,
													-1 == o.compare(r.row, r.column) && o.setStart(r),
														r = s.end,
													1 == o.compare(r.row, r.column) && o.setEnd(r),
														a = !0) : (r = s.start,
													-1 == o.compare(r.row, r.column) && (o = c.fromPoints(s.start, s.start)),
														a = !1);
											if (null  != i) {
												0 === c.comparePoints(i.start, o.start) && (i.start.column += o.end.column - o.start.column,
										...
										this.moveText = function(e, t, i) {
											...
											if (!i) {
												...
												s && r.start.row >= e.end.row && (r.start.row += s,
													r.end.row += s)
											}
											if (r.end = this.insert(r.start, n),
													o.length) {
												var l = e.start
													, h = r.start
													, s = h.row - l.row
										...
										this.outdentRows = function(e) {
											for (var t = e.collapseRows(), i = new c(0,0,0,0), n = this.getTabSize(), o = t.start.row; o <= t.end.row; ++o) {
												var r = this.getLine(o);
												i.start.row = o,
													i.end.row = o;
												for (var s = 0; n > s && " " == r.charAt(s); ++s)
													;
												n > s && "	" == r.charAt(s) ? (i.start.column = s,
										...
										this.$moveLines = function(e, t, i) {
											...
											var r = new c(e,0,t,Number.MAX_VALUE)
												, s = this.getFoldsInRange(r).map(function(e) {
														return e = e.clone(),
															e.start.row += o,
															e.end.row += o,
															e
											...
											return this.doc.insertFullLines(e + o, a),
										...
										if (this.$updating = !0,
											...
											if ("remove" === i) {
												...
												l = this.getFoldsInRange(e),
													this.removeFolds(l);
												var h = this.getFoldLine(o.row)
													, d = 0;
												if (h) {
													h.addRemoveChars(o.row, o.column, n.column - o.column),
														h.shiftRow(-a);
												...
												for (d; d < c.length; d++) {
													var h = c[d];
													h.start.row >= o.row && h.shiftRow(-a)
												}
												s = r
											} else {
												var f = Array(a);
												...
												g.splice.apply(g, f);
												var c = this.$foldData
													, h = this.getFoldLine(r)
													, d = 0;
												if (h) {
													var p = h.range.compareInside(n.row, n.column);
													0 == p ? (h = h.split(n.row, n.column),
													h && (h.shiftRow(a),
														h.addRemoveChars(s, 0, o.column - n.column))) : -1 == p && (h.addRemoveChars(r, 0, o.column - n.column),
														h.shiftRow(a)),
														d = c.indexOf(h) + 1
												}
												for (d; d < c.length; d++) {
									...
									this.$updateWrapData = function(e, t) {
										var i, n, o = this.doc.getAllLines(), r = this.getTabSize(), s = this.$wrapData, l = this.$wrapLimit, c = e;
										for (t = Math.min(t, o.length - 1); t >= c; )
											n = this.getFoldLine(c, n),
												n ? (i = [],
													n.walk(function(e, t, n, r) {
														var s;
														if (null  != e) {
															...
															s = this.$getDisplayTokens(o[t].substring(r, n), i.length);
														i = i.concat(s)
													}
														.bind(this), n.end.row, o[n.end.row].length + 1),
													s[n.start.row] = this.$computeWrapSplits(i, l, r),
													c = n.end.row + 1) : (i = this.$getDisplayTokens(o[c]),
													s[c] = this.$computeWrapSplits(i, l, r),
													c++)
									}
									;
									var t = 1
									...
									this.$computeWrapSplits = function(e, t, n) {
										...
										if (0 == e.length)
											return [];
										for (var s = [], l = e.length, c = 0, d = 0, u = this.$wrapAsCode, v = this.$indentedSoftWrap, w = t <= Math.max(2 * n, 8) || v === !1 ? 0 : Math.floor(t / 2), A = 0; l - c > t - A; ) {
											var C = c + t - A;
											if (e[C - 1] >= g && e[C] >= g)
												r(C);
											else if (e[C] != a && e[C] != h) {
												for (var E = Math.max(C - (t - (t >> 2)), c - 1); C > E && e[C] < a; )
													C--;
												if (u) {
													for (; C > E && e[C] < a; )
														C--;
										...
										,
										this.$getDisplayTokens = function(n, o) {
											var r, s = [];
											o = o || 0;
											for (var a = 0; a < n.length; a++) {
												var l = n.charCodeAt(a);
												if (9 == l) {
													r = this.getScreenTabSize(s.length + o),
														s.push(p);
													for (var c = 1; r > c; c++)
														s.push(m)
												} else
													32 == l ? s.push(g) : l > 39 && 48 > l || l > 57 && 64 > l ? s.push(f) : l >= 4352 && e(l) ? s.push(t, i) : s.push(t)
											}
											return s
										}
										,
										this.$getStringScreenWidth = function(t, i, n) {
											...
											null  == i && (i = 1 / 0),
												n = n || 0;
											var o, r;
											for (r = 0; r < t.length && (o = t.charCodeAt(r),
												n += 9 == o ? this.getScreenTabSize(n) : o >= 4352 && e(o) ? 2 : 1,
												!(n > i)); r++)
												;
											return [n, r]
										}
										...
										this.screenToDocumentPosition = function(e, t) {
											...
											if (h && c >= 0)
												...
												var d = !h;
											for (var u = this.getLength() - 1, f = this.getNextFoldLine(o), g = f ? f.start.row : 1 / 0; e >= s && (a = this.getRowLength(o),
												!(s + a > e || o >= u)); )
												s += a,
													o++,
												o > g && (o = f.end.row + 1,
											...
											if (this.$useWrapMode) {
												...
												if (m) {
													...
													n = m[v],
													v > 0 && m.length && (p = m.indent,
														r = m[v - 1] || m[m.length - 1],
														i = i.substring(r))
												}
											}
											return r += this.$getStringScreenWidth(i, t - p)[1],
										...
										this.documentToScreenPosition = function(e, t) {
											...
											var g = "";
											u && a >= f ? (g = this.getFoldDisplayLine(u, e, t),
												o = u.start.row) : (g = this.getLine(e).substring(0, t),
												o = e);
											var p = 0;
											if (this.$useWrapMode) {
												var m = this.$wrapData[o];
										...
										this.$setFontMetrics = function(e) {
											this.$enableVarChar && (this.$getStringScreenWidth = function(t, i, n) {
													...
													i || (i = 1 / 0),
														n = n || 0;
													var o, r;
													for (r = 0; r < t.length && (o = t.charAt(r),
														n += "	" === o ? this.getScreenTabSize(n) : e.getCharacterWidth(o),
														!(n > i)); r++)
														;
													return [n, r]
												}
									...
									this.set = function(e) {
										...
										this.findAll = function(e) {
											...
											if (t.$isMultiLine) {
												...
												e: for (var d = a.offset || 0; h >= d; d++) {
													...
													l && l.end.row === d && l.end.column > p || (s.push(l = new r(d,p,d + c - 1,m)),
													c > 2 && (d = d + c - 2))
												}
											} else
												for (var v = 0; v < o.length; v++)
													for (var w = n.getMatchOffsets(o[v], a), u = 0; u < w.length; u++) {
														var A = w[u];
														s.push(new r(v,A.offset,v,A.offset + A.length))
													}
											if (i) {
												for (var C = i.start.column, E = i.start.column, v = 0, u = s.length - 1; u > v && s[v].start.column < C && s[v].start.row == i.start.row; )
													v++;
												for (; u > v && s[u].end.column > E && s[u].end.row == i.end.row; )
													u--;
												for (s = s.slice(v, u + 1),
														 v = 0,
														 u = s.length; u > v; v++)
													s[v].start.row += i.start.row,
														...
														if (-1 != l) {
															for (var c = 1; s > c; c++)
																if (t = e.getLine(n + c),
																	-1 == t.search(i[c]))
																	return;
															var h = t.match(i[s - 1])[0].length
																, d = new r(n,l,n + s - 1,h);
															return 1 == i.offset ? (d.start.row--,
										...
										this.$lineIterator = function(e, t) {
											var i = 1 == t.backwards
												...
												, o = t.range
												, r = t.start;
											r || (r = o ? o[i ? "end" : "start"] : e.selection.getRange()),
											r.start && (r = r[n != i ? "end" : "start"]);
											var s = o ? o.start.row : 0
												, a = o ? o.end.row : e.getLength() - 1
												, l = i ? function(i) {
													var n = r.row
														, o = e.getLine(n).substring(0, r.column);
													if (!i(o, n)) {
														for (n--; n >= s; n--)
															if (i(e.getLine(n), n))
																return;
								...
								function() {
									...
									this.addCommand = function(e) {
										...
										this.bindKey = function(e, t, i) {
											return "object" == typeof e && (void 0 == i && (i = e.position),
												e = e[this.platform]),
										...
										this._addCommandToBinding = function(t, i, n) {
											...
											if (i)
												if (!r[t] || this.$singleCommand)
													r[t] = i;
												else {
													Array.isArray(r[t]) ? -1 != (o = r[t].indexOf(i)) && r[t].splice(o, 1) : r[t] = [r[t]],
										...
										this.handleKeyboard = function(e, t, i, n) {
											if (!(0 > n)) {
												...
												return e.$keyChain && (e.$keyChain += " " + o,
													r = this.commandKeyBinding[e.$keyChain] || r),
													!r || "chainKeys" != r && "chainKeys" != r[r.length - 1] ? (e.$keyChain && (t && 4 != t || 1 != i.length ? (-1 == t || n > 0) && (e.$keyChain = "") : e.$keyChain = e.$keyChain.slice(0, -o.length - 1)),
													{
														command: r
								...
								function() {
									n.implement(this, r),
										this.exec = function(e, t, i) {
											...
											return o.returnValue = this._emit("exec", o),
												this._signal("afterExec", o),
												o.returnValue === !1 ? !1 : !0
										}
										,
					...
					ace.define("ace/commands/default_commands", ["require", "exports", "module", "ace/lib/lang", "ace/config", "ace/range"], function(e, t, i) {
							...
							t.commands = [{
								...
								bindKey: n(null , null ),
								exec: function(e) {
									for (var t = e.selection.isBackwards(), i = t ? e.selection.getSelectionLead() : e.selection.getSelectionAnchor(), n = t ? e.selection.getSelectionAnchor() : e.selection.getSelectionLead(), r = e.session.doc.getLine(i.row).length, a = e.session.doc.getTextRange(e.selection.getRange()), l = a.replace(/\n\s*/, " ").length, c = e.session.doc.getLine(i.row), h = i.row + 1; h <= n.row + 1; h++) {
										var d = o.stringTrimLeft(o.stringTrimRight(e.session.doc.getLine(h)));
										0 !== d.length && (d = " " + d),
											c += d
									}
									n.row + 1 < e.session.doc.getLength() - 1 && (c += e.session.doc.getNewLineCharacter()),
										e.clearSelection(),
										e.session.doc.replace(new s(i.row,0,n.row + 2,0), c),
								...
								exec: function(e) {
									...
									for (var r = 0; r < n.length; r++)
										r == n.length - 1 && (n[r].end.row !== t || n[r].end.column !== i) && o.push(new s(n[r].end.row,n[r].end.column,t,i)),
											0 === r ? (0 !== n[r].start.row || 0 !== n[r].start.column) && o.push(new s(0,0,n[r].start.row,n[r].start.column)) : o.push(new s(n[r - 1].end.row,n[r - 1].end.column,n[r].start.row,n[r].start.column));
					...
					ace.define("ace/editor", ["require", "exports", "module", "ace/lib/fixoldbrowsers", "ace/lib/oop", "ace/lib/dom", "ace/lib/lang", "ace/lib/useragent", "ace/keyboard/textinput", "ace/mouse/mouse_handler", "ace/mouse/fold_handler", "ace/keyboard/keybinding", "ace/edit_session", "ace/search", "ace/range", "ace/lib/event_emitter", "ace/commands/command_manager", "ace/commands/default_commands", "ace/config", "ace/token_iterator"], function(e, t, i) {
							...
							(function() {
									n.implement(this, g),
												...
												if (i) {
													switch (i) {
														...
														case "selectionPart":
															...
															(n.start.row >= o.lastRow || n.end.row <= o.firstRow) && this.renderer.scrollSelectionIntoView(this.selection.anchor, this.selection.lead)
													}
												...
												this.$highlightPending = !0,
													setTimeout(function() {
															...
															if (t && t.bgTokenizer) {
																...
																if (i)
																	var n = new f(i.row,i.column,i.row,i.column + 1);
												...
												this.$highlightTagPending = !0,
													setTimeout(function() {
															...
															if (t && t.bgTokenizer) {
																...
																if (-1 == o.type.indexOf("tag-open") || (o = n.stepForward())) {
																	var r = o.value
																		, s = 0
																		, a = n.stepBackward();
																	if ("<" == a.value) {
																		do
																			a = o,
																				o = n.stepForward(),
																			o && o.value === r && -1 !== o.type.indexOf("tag-name") && ("<" === a.value ? s++ : "</" === a.value && s--);
																		while (o && s >= 0)
																	} else {
																		do
																			o = a,
																	...
																	var l = n.getCurrentTokenRow()
																		...
																		, h = new f(l,c,l,c + o.value.length);
										...
										this.$getSelectionHighLightRegexp = function() {
											...
											if (!t.isEmpty() && !t.isMultiLine()) {
												var i = t.start.column - 1
													...
													, r = o.length
													, s = o.substring(Math.max(i, 0), Math.min(n, r));
												if (!(i >= 0 && /^[\w\d]/.test(s) || r >= n && /[\w\d]$/.test(s)) && (s = o.substring(t.start.column, t.end.column),
														/^[\w\d]+$/.test(s))) {
										...
										this.$handlePaste = function(e) {
											...
											if (!this.inMultiSelectMode || this.inVirtualSelectionMode)
												...
												for (var o = n.length; o--; ) {
													var r = n[o];
													r.isEmpty() || this.session.remove(r),
														this.session.insert(r.start, i[o])
												}
											}
										}
										,
										...
										this.insert = function(e, t) {
											...
											if (this.getBehavioursEnabled() && !t) {
												var r = n.transformAction(i.getState(o.row), "insertion", this, i, e);
												r && (e !== r.text && (this.session.mergeUndoDeltas = !1,
											...
											i.insert(o, e);
											if (r && r.selection && (2 == r.selection.length ? this.selection.setSelectionRange(new f(o.row,c + r.selection[0],o.row,c + r.selection[1])) : this.selection.setSelectionRange(new f(o.row + r.selection[0],r.selection[1],o.row + r.selection[2],r.selection[3]))),
													i.getDocument().isNewLine(e)) {
												var u = n.getNextLineIndent(h, a.slice(0, o.column), i.getTabString());
												i.insert({
													row: o.row + 1,
													column: 0
												}, u)
											}
											d && n.autoOutdent(h, i, o.row)
										}
										,
										this.onTextInput = function(e) {
										...
										this.transposeLetters = function() {
											if (this.selection.isEmpty()) {
												...
												if (0 !== t) {
													...
													t < o.length ? (i = o.charAt(t) + o.charAt(t - 1),
														n = new f(e.row,t - 1,e.row,t + 1)) : (i = o.charAt(t - 1) + o.charAt(t - 2),
														n = new f(e.row,t - 2,e.row,t)),
										...
										this.indent = function() {
											...
											if (this.session.getUseSoftTabs())
												...
												for (var c = l % a; " " == o[t.start.column] && c; )
													t.start.column--,
														c--;
									...
									this.sortLines = function() {
										...
										for (var n = new f(0,0,0,0), o = e.first; o <= e.last; o++) {
											var r = t.getLine(o);
											n.start.row = o,
												n.end.row = o,
												n.end.column = r.length,
												t.replace(n, i[o - e.first])
										}
									}
									,
									...
									this.modifyNumber = function(e) {
										...
										if (!isNaN(parseFloat(o)) && isFinite(o)) {
											...
											if (r) {
												...
												l *= Math.pow(10, a),
													e *= s !== r.end && s > i ? Math.pow(10, r.end - i - 1) : Math.pow(10, r.end - i),
													l += e,
													l /= Math.pow(10, a);
												var c = l.toFixed(a)
													, h = new f(t,r.start,t,r.end);
												this.session.replace(h, c),
													this.moveCursorTo(t, Math.max(r.start + 1, i + c.length - r.value.length))
											}
										}
									}
									,
									...
									this.duplicateSelection = function() {
										...
										if (i.isEmpty()) {
											...
											var r = n ? i.start : i.end
												, s = t.insert(r, t.getTextRange(i), !1);
											i.start = r,
												i.end = s,
									...
									this.$moveLines = function(e, t) {
										...
										if (!o.inMultiSelectMode || this.inVirtualSelectionMode) {
											...
											t && -1 == e && (n = 0),
												r.moveBy(n, 0),
												o.fromOrientedRange(r)
										} else {
											var s = o.rangeList.ranges;
											o.rangeList.detach(this.session),
											...
											for (var a = 0, l = 0, c = s.length, h = 0; c > h; h++) {
												...
												for (h--,
														 a = this.session.$moveLines(u, f, t ? 0 : e),
													 t && -1 == e && (d = h + 1); h >= d; )
													s[d].moveBy(a, 0),
														d++;
												t || (a = 0),
											...
											o.fromOrientedRange(o.ranges[0]),
												o.rangeList.attach(this.session),
									...
									this.$moveByPage = function(e, t) {
										var i = this.renderer
											...
											, o = e * Math.floor(n.height / n.lineHeight);
										this.$blockScrolling++,
											t === !0 ? this.selection.$moveSelection(function() {
													this.moveCursorBy(o, 0)
												}
											) : t === !1 && (this.selection.moveCursorBy(o, 0),
												this.selection.clearSelection()),
											this.$blockScrolling--;
										var r = i.scrollTop;
										i.scrollBy(0, o * n.lineHeight),
									...
									this.jumpToMatching = function(e, t) {
										var i = this.getCursorPosition()
											...
											, r = o || n.stepForward();
										if (r) {
											var s, a, l = !1, c = {}, h = i.column - r.start, d = {
												")": "(",
												"(": "(",
												"]": "[",
												"[": "[",
											...
											do {
												if (r.value.match(/[{}()\[\]]/g)) {
													for (; h < r.value.length && !l; h++)
														if (d[r.value[h]])
															switch (a = d[r.value[h]] + "." + r.type.replace("rparen", "lparen"),
															isNaN(c[a]) && (c[a] = 0),
																r.value[h]) {
																case "(":
																case "[":
													...
													r && -1 !== r.type.indexOf("tag-name") && (isNaN(c[r.value]) && (c[r.value] = 0),
														"<" === o.value ? c[r.value]++ : "</" === o.value && c[r.value]--,
													-1 === c[r.value] && (s = "tag",
														l = !0));
												l || (o = r,
													r = n.stepForward(),
												...
												var u, g;
												if ("bracket" === s)
													u = this.session.getBracketRange(i),
													u || (u = new f(n.getCurrentTokenRow(),n.getCurrentTokenColumn() + h - 1,n.getCurrentTokenRow(),n.getCurrentTokenColumn() + h - 1),
														g = u.start,
													(t || g.row === i.row && Math.abs(g.column - i.column) < 2) && (u = this.session.getBracketRange(g)));
												else if ("tag" === s) {
													if (!r || -1 === r.type.indexOf("tag-name"))
														return;
													var p = r.value;
													if (u = new f(n.getCurrentTokenRow(),n.getCurrentTokenColumn() - 2,n.getCurrentTokenRow(),n.getCurrentTokenColumn() - 2),
														0 === u.compare(i.row, i.column)) {
														l = !1;
														do
															r = o,
																o = n.stepBackward(),
															o && (-1 !== o.type.indexOf("tag-close") && u.setEnd(n.getCurrentTokenRow(), n.getCurrentTokenColumn() + 1),
															r.value === p && -1 !== r.type.indexOf("tag-name") && ("<" === o.value ? c[p]++ : "</" === o.value && c[p]--,
															0 === c[p] && (l = !0)));
														while (o && !l)
													}
													r && r.type.indexOf("tag-name") && (g = u.start,
													g.row == i.row && Math.abs(g.column - i.column) < 2 && (g = u.end))
												}
												g = u && u.cursor || g,
												g && (e ? u && t ? this.selection.setRange(u) : u && u.isEqual(this.getSelectionRange()) ? this.clearSelection() : this.selection.selectTo(g.row, g.column) : this.selection.moveTo(g.row, g.column))
											}
										}
									}
									,
									...
									this.find = function(e, t, i) {
										...
										return t.preventScroll ? r : r ? (this.revealRange(r, i),
											r) : (t.backwards ? o.start = o.end : o.end = o.start,
										...
										if (e) {
												...
												, a = this.renderer.on("afterRender", function() {
														if (n && t && (i.isFocused() || i.searchBox && i.searchBox.isFocused())) {
															var e = i.renderer
																...
																, s = e.layerConfig
																, a = r.top - s.offset;
															n = r.top >= 0 && a + t.top < 0 ? !0 : r.top < s.height && r.top + t.top + s.lineHeight > window.innerHeight ? !1 : null ,
															null  != n && (o.style.top = a + "px",
																o.style.left = r.left + "px",
																o.style.height = s.lineHeight + "px",
																o.scrollIntoView(n)),
																n = t = null
														}
													}
											...
											this.setAutoScrollEditorIntoView = function(e) {
												e || (delete this.setAutoScrollEditorIntoView,
													...
													this.renderer.removeEventListener("beforeRender", s))
											}
										}
									}
									,
								...
								v.defineOptions(A.prototype, "editor", {
									selectionStyle: {
										set: function(e) {
											this.onSelectionChange(),
							...
							(function() {
									...
									function i(e, t) {
										for (var i = new Array(e.length), n = 0; n < e.length; n++) {
											for (var o = e[n], r = {
												group: o.group,
												deltas: new Array(o.length)
											}, s = 0; s < o.deltas.length; s++) {
												var a = o.deltas[s];
												r.deltas[s] = t(a)
											}
											i[n] = r
							...
							(function() {
									o.implement(this, s),
										...
										this.update = function(e) {
											for (var t = this.session, i = e.firstRow, o = Math.min(e.lastRow + e.gutterOffset, t.getLength() - 1), r = t.getNextFoldLine(i), s = r ? r.start.row : 1 / 0, a = this.$showFoldWidgets && t.foldWidgets, l = t.$breakpoints, c = t.$decorations, h = t.$firstLineNumber, d = 0, u = t.gutterRenderer || this.$renderer, f = null , g = -1, p = i; ; ) {
												if (p > s && (p = r.end.row + 1,
														r = t.getNextFoldLine(p, r),
														s = r ? r.start.row : 1 / 0),
													p > o) {
												...
												if (w) {
													f.foldWidget || (f.foldWidget = n.createElement("span"),
														f.element.appendChild(f.foldWidget));
													var m = "ace_fold-widget ace_" + w;
													m += "start" == w && p == s && p < r.end.row ? " ace_closed" : " ace_open",
													...
													f.foldWidget && (f.element.removeChild(f.foldWidget),
														f.foldWidget = null );
												var A = d = u ? u.getText(t, p) : p + h;
												A != f.textNode.data && (f.textNode.data = A),
													p++
											}
					...
					ace.define("ace/layer/marker", ["require", "exports", "module", "ace/range", "ace/lib/dom"], function(e, t, i) {
							...
							(function() {
									...
									this.$padding = 0,
										...
										this.update = function(e) {
											...
											if (e) {
												...
												for (var i in this.markers) {
													...
													if (n.range) {
														var o = n.range.clipRows(e.firstRow, e.lastRow);
														if (!o.isEmpty())
															if (o = o.toScreenRange(this.session),
																	n.renderer) {
																var r = this.$getTop(o.start.row, e)
																	, s = this.$padding + o.start.column * e.characterWidth;
																n.renderer(t, o, s, r, e)
															} else
																"fullLine" == n.type ? this.drawFullLineMarker(t, o, n.clazz, e) : "screenLine" == n.type ? this.drawScreenLineMarker(t, o, n.clazz, e) : o.isMultiLine() ? "text" == n.type ? this.drawTextMarker(t, o, n.clazz, e) : this.drawMultiLineMarker(t, o, n.clazz, e) : this.drawSingleLineMarker(t, o, n.clazz + " ace_start ace_br15", e)
													} else
										...
										,
										this.drawTextMarker = function(t, i, o, r, s) {
											for (var a = this.session, l = i.start.row, c = i.end.row, h = l, d = 0, u = 0, f = a.getScreenLastRowColumn(h), g = new n(h,i.start.column,h,u); c >= h; h++)
												g.start.row = g.end.row = h,
													g.start.column = h == l ? i.start.column : a.getRowWrapIndent(h),
													g.end.column = f,
													d = u,
													u = f,
													f = c > h + 1 ? a.getScreenLastRowColumn(h + 1) : h == c ? 0 : i.end.column,
													this.drawSingleLineMarker(t, g, o + (h == l ? " ace_start" : "") + " ace_br" + e(h == l || h == l + 1 && i.start.column, u > d, u > f, h == c), r, h == c ? 0 : 1, s)
										}
										,
										this.drawMultiLineMarker = function(e, t, i, n, o) {
											...
											o = o || "",
												e.push("<div class='", i, " ace_br1 ace_start' style='", "height:", s, "px;", "right:0;", "top:", a, "px;", "left:", l, "px;", o, "'></div>"),
												a = this.$getTop(t.end.row, n);
											var c = t.end.column * n.characterWidth;
											if (e.push("<div class='", i, " ace_br12' style='", "height:", s, "px;", "width:", c, "px;", "top:", a, "px;", "left:", r, "px;", o, "'></div>"),
													s = (t.end.row - t.start.row - 1) * n.lineHeight,
													!(0 >= s)) {
												a = this.$getTop(t.start.row + 1, n);
												var h = (t.start.column ? 1 : 0) | (t.end.column ? 0 : 8);
												e.push("<div class='", i, h ? " ace_br" + h : "", "' style='", "height:", s, "px;", "right:0;", "top:", a, "px;", "left:", r, "px;", o, "'></div>")
											}
										}
										,
										this.drawSingleLineMarker = function(e, t, i, n, o, r) {
											var s = n.lineHeight
											...
											e.push("<div class='", i, "' style='", "height:", s, "px;", "width:", a, "px;", "top:", l, "px;", "left:", c, "px;", r || "", "'></div>")
										}
										,
										this.drawFullLineMarker = function(e, t, i, n, o) {
											var r = this.$getTop(t.start.row, n)
												, s = n.lineHeight;
											t.start.row != t.end.row && (s += this.$getTop(t.end.row, n) - r),
												e.push("<div class='", i, "' style='", "height:", s, "px;", "top:", r, "px;", "left:0;right:0;", o || "", "'></div>")
										}
										,
									...
									n.implement(this, s),
										...
										this.onChangeTabSize = this.$computeTabString = function() {
											...
											for (var t = this.$tabStrings = [0], i = 1; e + 1 > i; i++)
												this.showInvisibles ? t.push("<span class='ace_invisible ace_invisible_tab'>" + r.stringRepeat(this.TAB_CHAR, i) + "</span>") : t.push(r.stringRepeat(" ", i));
										...
										this.updateLines = function(e, t, i) {
											(this.config.lastRow != e.lastRow || this.config.firstRow != e.firstRow) && this.scrollLines(e),
												this.config = e;
											for (var n = Math.max(t, e.firstRow), o = Math.min(i, e.lastRow), r = this.element.childNodes, s = 0, a = e.firstRow; n > a; a++) {
										...
										this.$renderLinesFragment = function(e, t, i) {
											for (var n = this.element.ownerDocument.createDocumentFragment(), r = t, s = this.session.getNextFoldLine(r), a = s ? s.start.row : 1 / 0; ; ) {
												if (r > a && (r = s.end.row + 1,
												...
												var l = o.createElement("div")
													, c = [];
												if (this.$renderLine(c, r, !1, r == a ? s : !1),
														l.innerHTML = c.join(""),
														this.$useLineGroups())
										...
										this.update = function(e) {
											this.config = e;
											for (var t = [], i = e.firstRow, n = e.lastRow, o = i, r = this.session.getNextFoldLine(o), s = r ? r.start.row : 1 / 0; ; ) {
												if (o > s && (o = r.end.row + 1,
											...
											var o = this
												...
												, a = function(e, i, n, s, a) {
													...
													if (">" == e)
														return "&#62;";
													if ("	" == e) {
														var l = o.session.getScreenTabSize(t + s);
														return t += l - 1,
															o.$tabStrings[l]
													}
													if ("　" == e) {
														...
														return t += 1,
														"<span class='" + c + "' style='width:" + 2 * o.config.characterWidth + "px'>" + h + "</span>"
													}
										...
										this.$renderSimpleLine = function(e, t) {
											var i = 0
												, n = t[0]
												, o = n.value;
											this.displayIndentGuides && (o = this.renderIndentGuide(e, o)),
											o && (i = this.$renderToken(e, i, n, o));
											for (var r = 1; r < t.length; r++)
												n = t[r],
													o = n.value,
													i = this.$renderToken(e, i, n, o)
										}
										,
					...
					ace.define("ace/layer/cursor", ["require", "exports", "module", "ace/lib/dom"], function(e, t, i) {
							"use strict";
							var n, o = e("../lib/dom"), r = function(e) {
									this.element = o.createElement("div"),
									...
									void 0 === n && (n = !("opacity" in this.element.style)),
										...
										o.addCssClass(this.element, "ace_hidden-cursors"),
							...
							(function() {
									this.$updateVisibility = function(e) {
										...
										this.setSmoothBlinking = function(e) {
											e == this.smoothBlinking || n || (this.smoothBlinking = e,
												o.setCssClass(this.element, "ace_smooth-blinking", e),
										...
										this.showCursor = function() {
											this.isVisible = !0,
												o.removeCssClass(this.element, "ace_hidden-cursors"),
												this.restartTimer()
										}
										,
										this.restartTimer = function() {
											...
											if (clearInterval(this.intervalId),
												...
												this.smoothBlinking && o.removeCssClass(this.element, "ace_smooth-blinking"),
													e(!0),
												this.isBlinking && this.blinkInterval && this.isVisible) {
												this.smoothBlinking && setTimeout(function() {
													o.addCssClass(this.element, "ace_smooth-blinking")
												}
													.bind(this));
												var t = function() {
										...
										this.update = function(e) {
											...
											for (var i = 0, o = t.length; o > i; i++) {
												...
												if (!((r.top > e.height + e.offset || r.top < 0) && i > 1)) {
													...
													this.drawCursor ? this.drawCursor(s, r, e, t[i], this.session) : (s.left = r.left + "px",
														s.top = r.top + "px",
										...
										this.$setOverwrite = function(e) {
											e != this.overwrite && (this.overwrite = e,
												e ? o.addCssClass(this.element, "ace_overwrite-cursors") : o.removeCssClass(this.element, "ace_overwrite-cursors"))
										}
										,
										this.destroy = function() {
					...
					ace.define("ace/layer/font_metrics", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/lang", "ace/lib/useragent", "ace/lib/event_emitter"], function(e, t, i) {
							var n = e("../lib/oop")
								...
								, l = 0
								, c = t.FontMetrics = function(e, t) {
									this.el = o.createElement("div"),
										this.$setMeasureNodeStyles(this.el.style, !0),
										this.$main = o.createElement("div"),
										this.$setMeasureNodeStyles(this.$main.style),
										this.$measureNode = o.createElement("div"),
					...
					ace.define("ace/virtual_renderer", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/config", "ace/lib/useragent", "ace/layer/gutter", "ace/layer/marker", "ace/layer/text", "ace/layer/cursor", "ace/scrollbar", "ace/scrollbar", "ace/renderloop", "ace/layer/font_metrics", "ace/lib/event_emitter"], function(e, t, i) {
							...
							o.importCssString(m, "ace_editor.css");
							var v = function(e, t) {
									var i = this;
									this.container = e || o.createElement("div"),
										this.$keepTextAreaAtCursor = !s.isOldIE,
										o.addCssClass(this.container, "ace_editor"),
										this.setTheme(t),
										this.$gutter = o.createElement("div"),
										this.$gutter.className = "ace_gutter",
										this.container.appendChild(this.$gutter),
										this.scroller = o.createElement("div"),
										this.scroller.className = "ace_scroller",
										this.container.appendChild(this.scroller),
										this.content = o.createElement("div"),
									...
									this.canvas = n.element,
										...
										this.scrollBarH = new d(this.container,this),
							...
							(function() {
									this.CHANGE_CURSOR = 1,
										...
										this.onResize = function(e, t, i, n) {
											if (!(this.resizing > 2)) {
												...
												e && (this.$gutterLayer.$padding = null ),
													e ? this.$renderChanges(r | this.$changes, !0) : this.$loop.schedule(r | this.$changes),
											...
											if (this.$showPrintMargin || this.$printMarginEl) {
												if (!this.$printMarginEl) {
													...
													e.className = "ace_layer ace_print-margin-layer",
														this.$printMarginEl = o.createElement("div"),
										...
										this.$moveTextAreaToCursor = function() {
											if (this.$keepTextAreaAtCursor) {
												...
												i > this.$size.scrollerWidth - r && (i = this.$size.scrollerWidth - r),
													...
													n.top = Math.min(t, this.$size.height - o) + "px"
											}
										}
										,
										this.getFirstVisibleRow = function() {
										...
										this.setScrollMargin = function(e, t, i, n) {
											...
											o.top = 0 | e,
												...
												o.v = o.top + o.bottom,
												o.h = o.left + o.right,
											o.top && this.scrollTop <= 0 && this.session && this.session.setScrollTop(-o.top),
												this.updateFull()
										}
										,
										...
										this.$autosize = function() {
											...
											if (i != this.desiredHeight || this.$size.height != this.desiredHeight || n != this.$vScroll) {
												...
												this.container.style.height = i + "px",
													this.$updateCachedSize(!0, this.$gutterWidth, o, i),
										...
										this.$computeLayerConfig = function() {
											...
											this.session.setScrollTop(Math.max(-u.top, Math.min(this.scrollTop, o - t.scrollerHeight + u.bottom))),
												this.session.setScrollLeft(Math.max(-u.left, Math.min(this.scrollLeft, r + 2 * this.$padding - t.scrollerWidth + u.right)));
											var f = !i && (this.$vScrollBarAlwaysVisible || t.scrollerHeight - o + d < 0 || this.scrollTop > u.top)
												, g = l !== f;
											g && (this.$vScroll = f,
												this.scrollBarV.setVisible(f));
											var p, m, v = Math.ceil(h / this.lineHeight) - 1, w = Math.max(0, Math.round((this.scrollTop - c) / this.lineHeight)), A = w + v, C = this.lineHeight;
											w = e.screenToDocumentRow(w, 0);
											var E = e.getFoldLine(w);
											E && (w = E.start.row),
												p = e.documentToScreenRow(w, 0),
												m = e.getRowLength(w) * C,
												A = Math.min(e.screenToDocumentRow(A, 0), e.getLength() - 1),
												h = t.scrollerHeight + e.getRowLength(A) * C + m,
												c = this.scrollTop - p * C;
											var y = 0;
											return this.layerConfig.width != r && (y = this.CHANGE_H_SCROLL),
											(a || g) && (y = this.$updateCachedSize(!0, this.gutterWidth, t.width, t.height),
												this._signal("scrollbarVisibilityChanged"),
											g && (r = this.$getLongestLine())),
												this.layerConfig = {
													width: r,
													...
													maxHeight: o,
													offset: c,
													gutterOffset: Math.max(0, Math.ceil((c + t.height - t.scrollerHeight) / C)),
										...
										this.$updateLines = function() {
											...
											var i = this.layerConfig;
											return e > i.lastRow + 1 || t < i.firstRow ? void 0 : t === 1 / 0 ? (this.$showGutter && this.$gutterLayer.update(i),
										...
										this.scrollCursorIntoView = function(e, t, i) {
											if (0 !== this.$size.scrollerHeight) {
												...
												l + s > r ? (t && (r -= t * this.$size.scrollerHeight),
										...
										this.alignCursor = function(e, t) {
											...
											var i = this.$cursorLayer.getPixelPosition(e)
												...
												, o = i.top - n * (t || 0);
											return this.session.setScrollTop(o),
												o
										}
										,
										this.STEPS = 8,
												...
												if (e != i) {
													...
													this.$scrollAnimation = {
														...
														this.$timer = setInterval(function() {
																r.length ? (n.session.setScrollTop(r.shift()),
										...
										this.visualizeFocus = function() {
											o.addCssClass(this.container, "ace_focus")
										}
										,
										this.visualizeBlur = function() {
											o.removeCssClass(this.container, "ace_focus")
										}
										,
									...
									this.hideComposition = function() {
										this.$composition && (o.removeCssClass(this.textarea, "ace_composition"),
									...
									this.setTheme = function(e, t) {
										function i(i) {
											if (n.$themeId != e)
												return t && t();
											if (i.cssClass) {
												o.importCssString(i.cssText, i.cssClass, n.container.ownerDocument),
												n.theme && o.removeCssClass(n.container, n.theme.cssClass);
												var r = "padding" in i ? i.padding : "padding" in (n.theme || {}) ? 4 : n.$padding;
												n.$padding && r != n.$padding && n.setPadding(r),
													n.$theme = i.cssClass,
													n.theme = i,
													o.addCssClass(n.container, i.cssClass),
													o.setCssClass(n.container, "ace_dark", i.isDark),
									...
									this.setStyle = function(e, t) {
										o.setCssClass(this.container, e, t !== !1)
									}
									,
									this.unsetStyle = function(e) {
										o.removeCssClass(this.container, e)
									}
									,
								...
								r.defineOptions(v.prototype, "renderer", {
									animatedScroll: {
										initialValue: !1
									},
									showInvisibles: {
									...
									fadeFoldWidgets: {
										set: function(e) {
											o.setCssClass(this.$gutter, "ace_fade-fold-widgets", e)
										},
										initialValue: !1
									},
									showFoldWidgets: {
									...
									highlightGutterLine: {
										set: function(e) {
											return this.$gutterLineHighlight ? (this.$gutterLineHighlight.style.display = e ? "" : "none",
												void (this.$cursorLayer.$pixelPos && this.$updateGutterLineHighlight())) : (this.$gutterLineHighlight = o.createElement("div"),
							...
							var o = e("../lib/oop")
								...
								, l = function(t, n, o, r) {
									...
									try {
										...
										if (!(f instanceof window.DOMException))
											throw f;
										var d = this.$workerBlob(r)
											, g = window.URL || window.webkitURL
											, p = g.createObjectURL(d);
							...
							var c = function(e, t, i) {
									...
									r.postMessage = function(e) {
										...
										a.loadModule(["worker", t], function(e) {
												for (n = new e[i](r); l.messageBuffer.length; )
													c()
											}
										)
								}
							...
							(function() {
									r.implement(this, o),
										this.setup = function() {
											...
											o.$insertRight = !0,
												o.detach(),
												o.markerId = i.addMarker(new n(o.row,o.column,o.row,o.column + this.length), this.mainClass, null , !1),
												this.others = [],
												...
												var e = this
													...
													, i = function(i, o) {
														t.removeMarker(i.markerId),
															i.markerId = t.addMarker(new n(i.row,i.column,i.row,i.column + e.length), o, null , !1)
													}
													;
												i(this.pos, this.mainClass);
												for (var o = this.others.length; o--; )
													i(this.others[o], this.othersClass)
											}
										}
										,
					...
					ace.define("ace/mouse/multi_select_handler", ["require", "exports", "module", "ace/lib/event", "ace/lib/useragent"], function(e, t, i) {
							...
							function o(e) {
								...
								if (0 === c) {
									var h, d = e.editor, u = d.selection, f = d.inMultiSelectMode, g = e.getDocumentPosition(), p = u.getCursor(), m = e.inSelection() || u.isEmpty() && n(g, p), v = e.x, w = e.y, A = function(e) {
											v = e.clientX,
												w = e.clientY
										}
										, C = d.session, E = d.renderer.pixelToScreenCoordinates(v, w), y = E;
									if (d.$mouseHandler.$enableJumpToDef)
										a && i || l && i ? h = o ? "block" : "add" : i && d.$blockSelectEnabled && (h = "block");
									else if (l && !i) {
										if (h = "add",
											!f && o)
											return
									} else
										i && d.$blockSelectEnabled && (h = "block");
									if (h && s.isMac && t.ctrlKey && d.$mouseHandler.cancelContextMenu(),
										"add" == h) {
										if (!f && m)
											return;
										if (!f) {
										...
										var F = u.rangeList.rangeAtPoint(g);
										d.$blockScrolling++,
											d.inVirtualSelectionMode = !0,
										o && (F = null ,
											b = u.ranges[0] || b,
											d.removeSelectionMarker(b)),
											d.once("mouseup", function() {
													var e = u.toOrientedRange();
													F && e.isEmpty() && n(F.cursor, e.cursor) ? u.substractPoint(e.cursor) : (o ? u.substractPoint(b.cursor) : b && (d.removeSelectionMarker(b),
														u.addRange(b)),
														u.addRange(e)),
														d.$blockScrolling--,
										...
										e.stop(),
											d.inVirtualSelectionMode = !0;
										var x, S = [], D = function() {
												var e = d.renderer.pixelToScreenCoordinates(v, w)
													, t = C.screenToDocumentPosition(e.row, e.column);
												n(y, e) && n(t, u.lead) || (y = e,
													d.$blockScrolling++,
													d.selection.moveToPosition(t),
													d.renderer.scrollCursorIntoView(),
													d.removeSelectionMarkers(S),
													S = u.rectangularRangeBlock(y, E),
												d.$mouseHandler.$clickSelection && 1 == S.length && S[0].isEmpty() && (S[0] = d.$mouseHandler.$clickSelection.clone()),
													S.forEach(d.addSelectionMarker, d),
													d.updateSelectionMarkers(),
													d.$blockScrolling--)
											}
											;
										d.$blockScrolling++,
											f && !l ? u.toSingleRange() : !f && l && (x = u.toOrientedRange(),
												d.addSelectionMarker(x)),
											o ? E = C.documentToScreenPosition(u.lead) : u.moveToPosition(g),
											d.$blockScrolling--,
											y = {
												row: -1,
												column: -1
					...
					ace.define("ace/multi_select", ["require", "exports", "module", "ace/range_list", "ace/range", "ace/selection", "ace/mouse/multi_select_handler", "ace/lib/event", "ace/lib/lang", "ace/commands/multi_select_commands", "ace/search", "ace/edit_session", "ace/editor", "ace/config"], function(e, t, i) {
							...
							function s(e) {
								...
								d.addListener(i, "keydown", function(i) {
										var o = 18 == i.keyCode && !(i.ctrlKey || i.shiftKey || i.metaKey);
										e.$blockSelectEnabled && o ? n || (e.renderer.setMouseCursor("crosshair"),
											n = !0) : n && t()
									}
								),
									d.addListener(i, "keyup", t),
									d.addListener(i, "blur", t)
							}
									...
									this.ranges = null ,
										...
										this.rectangularRangeBlock = function(e, t, i) {
											...
											for (var u = h; d >= u; u++) {
												...
												f.cursor = r ? f.start : f.end,
													n.push(f)
											}
											if (c && n.reverse(),
													!i) {
												for (var p = n.length - 1; n[p].isEmpty() && p > 0; )
													p--;
												if (p > 0)
													for (var m = 0; n[m].isEmpty(); )
														m++;
												for (var v = p; v >= m; v--)
													n[v].isEmpty() && n.splice(v, 1)
											}
											return n
										}
								}
									...
									this.updateSelectionMarkers = function() {
										...
										this.forEachSelection = function(e, t, i) {
											if (!this.inVirtualSelectionMode) {
												var n, o = i && i.keepOrder, r = 1 == i || i && i.$byLines, s = this.session, a = this.selection, l = a.rangeList, h = (o ? a : l).ranges;
												if (!h.length)
										...
										this.getSelectedText = function() {
											...
											if (this.inMultiSelectMode && !this.inVirtualSelectionMode) {
												...
												e = i.join(o),
												e.length == (i.length - 1) * o.length && (e = "")
											} else
										...
										this.findAll = function(e, t, i) {
											...
											i || r.toSingleRange(o[0]);
											for (var s = o.length; s--; )
												r.addRange(o[s], !0);
											return n && r.rangeList.rangeAtPoint(n.start) && r.addRange(n, !0),
												this.$blockScrolling -= 1,
												o.length
										}
										,
										this.selectMoreLines = function(e, t) {
											...
											if (n) {
												var c = l.fromPoints(r, s);
												c.cursor = c.start
											} else {
												var c = l.fromPoints(s, r);
												c.cursor = c.end
											}
										...
										this.transposeSelections = function(e) {
											for (var t = this.session, i = t.multiSelect, n = i.ranges, o = n.length; o--; ) {
												...
												if (r.isEmpty()) {
													...
													r.start.row = s.start.row,
														r.start.column = s.start.column,
														r.end.row = s.end.row,
										...
										this.selectMore = function(e, t, i) {
											var o = this.session
												, r = o.multiSelect
												, s = r.toOrientedRange();
											if (!s.isEmpty() || (s = o.getWordRange(s.start.row, s.start.column),
													s.cursor = -1 == e ? s.start : s.end,
													this.multiSelect.addRange(s),
													!i)) {
												var a = o.getTextRange(s)
													, l = n(o, a, e);
											...
											if (i.length && o.length != i.length - 1) {
												...
												var r = 0
													...
													, a = i.map(function(t) {
															var i = t.cursor
																, n = e.getLine(i.row)
																, o = n.substr(i.column).search(/\S/g);
															return -1 == o && (o = 0),
															i.column > r && (r = i.column),
															s > o && (s = o),
																o
														}
													);
												i.forEach(function(t, i) {
														var n = t.cursor
															, o = r - n.column
															, c = a[i] - s;
														o > c ? e.insert(n, u.stringRepeat(" ", o - c)) : e.remove(new l(n.row,n.column,n.row,n.column - o + c)),
										...
										set: function(e) {
											r(this),
												e ? (this.on("changeSession", this.$multiselectOnSessionChange),
													this.on("mousedown", h)) : (this.off("changeSession", this.$multiselectOnSessionChange),
													this.off("mousedown", h))
										},
										value: !0
									},
									enableBlockSelect: {
					...
					ace.define("ace/mode/folding/fold_mode", ["require", "exports", "module", "ace/range"], function(e, t, i) {
							...
							(function() {
									this.foldingStartMarker = null ,
										...
										,
										this.closingBracketBlock = function(e, t, i, o, r) {
											var s = {
													row: i,
													column: o
												}
							...
							(function() {
									this.getRowLength = function(e) {
										...
										this.updateOnFold = function(e, t) {
											var i = t.lineWidgets;
											if (i && e.action) {
												for (var n = e.data, o = n.start.row, r = n.end.row, s = "add" == e.action, a = o + 1; r > a; a++)
													i[a] && (i[a].hidden = s);
												i[r] && (s ? i[o] ? i[r].hidden = s : i[o] = i[r] : (i[o] == i[r] && (i[o] = void 0),
													i[r].hidden = s))
											}
										}
										,
										...
										this.addLineWidget = function(e) {
											...
											var i = this.editor.renderer;
											e.html && !e.el && (e.el = o.createElement("div"),
												e.el.innerHTML = e.html),
											e.el && (o.addCssClass(e.el, "ace_lineWidgetContainer"),
					...
					ace.define("ace/ext/error_marker", ["require", "exports", "module", "ace/line_widgets", "ace/lib/dom", "ace/range"], function(e, t, i) {
							...
							function o(e, t, i) {
								var o = e.getAnnotations().sort(a.comparePoints);
								if (o.length) {
									var r = n(o, {
										row: t,
										column: -1
									...
									0 > r && (r = -r - 1),
										r >= o.length ? r = i > 0 ? 0 : o.length - 1 : 0 === r && 0 > i && (r = o.length - 1);
									var s = o[r];
									if (s && i) {
										if (s.row === t) {
											do
												s = o[r += i];
											while (s && s.row === t);if (!s)
												return o.slice()
										}
										var l = [];
										t = s.row;
										do
											l[0 > i ? "unshift" : "push"](s),
												s = o[r += i];
										while (s && s.row == t);return l.length && l
									}
								}
							}
							...
							t.showErrorMarker = function(e, t) {
								...
								if (h) {
									var d = h[0];
									n.column = (d.pos && "number" != typeof d.column ? d.pos.sc : d.column) || 0,
										n.row = d.row,
										c = e.renderer.$gutterLayer.$annotations[n.row]
								} else {
									if (l)
										return;
									c = {
								...
								var u = {
									...
									, f = u.el.appendChild(s.createElement("div"))
									, g = u.el.appendChild(s.createElement("div"));
								g.className = "error_widget_arrow " + c.className;
								var p = e.renderer.$cursorLayer.getPixelPosition(n).left;
			...
			, function(e, t, i) {
				ace.define("ace/mode/json_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(e, t, i) {
					...
					ace.define("ace/mode/behaviour/cstyle", ["require", "exports", "module", "ace/lib/oop", "ace/mode/behaviour", "ace/token_iterator", "ace/lib/lang"], function(e, t, i) {
							"use strict";
							var n, o = e("../../lib/oop"), r = e("../behaviour").Behaviour, s = e("../../token_iterator").TokenIterator, a = e("../../lib/lang"), l = ["text", "paren.rparen", "punctuation.operator"], c = ["text", "paren.rparen", "punctuation.operator", "comment"], h = {}, d = function(e) {
									var t = -1;
									return e.multiSelect && (t = e.selection.index,
									h.rangeCount != e.multiSelect.rangeCount && (h = {
										rangeCount: e.multiSelect.rangeCount
									})),
										h[t] ? n = h[t] : void (n = h[t] = {
								...
								, f = function() {
									this.add("braces", "insertion", function(e, t, i, o, r) {
											...
											if ("{" == r) {
												d(i);
												var c = i.getSelectionRange()
													, h = o.doc.getTextRange(c);
												if ("" !== h && "{" !== h && i.getWrapBehavioursEnabled())
													return u(c, h, "{", "}");
												if (f.isSaneInsertion(i, o))
													return /[\]\}\)]/.test(l[s.column]) || i.inMultiSelectMode ? (f.recordAutoInsert(i, o, "}"),
													{
														text: "{}",
														selection: [1, 1]
													}) : (f.recordMaybeInsert(i, o, "{"),
													{
														text: "{",
														selection: [1, 1]
													})
												...
												if ("}" == g) {
													var p = o.$findOpeningBracket("}", {
														column: s.column + 1,
														row: s.row
													});
													if (null  !== p && f.isAutoInsertedClosing(s, l, r))
												...
												if ("\n" == r || "\r\n" == r) {
													d(i);
													var m = "";
													f.isMaybeInsertedClosing(s, l) && (m = a.stringRepeat("}", n.maybeInsertedBrackets),
										...
										this.add("parens", "insertion", function(e, t, i, n, o) {
												if ("(" == o) {
													...
													if (")" == c) {
														...
														if (null  !== h && f.isAutoInsertedClosing(a, l, o))
															return f.popAutoInsertedClosing(),
															{
																text: "",
																selection: [1, 1]
										...
										this.add("parens", "deletion", function(e, t, i, n, o) {
												...
												if (!o.isMultiLine() && "(" == r) {
													d(i);
													var s = n.doc.getLine(o.start.row)
												...
												if ('"' == o || "'" == o) {
													...
													if (!a) {
														var l = i.getCursorPosition()
															...
															, h = c.substring(l.column - 1, l.column)
															, f = c.substring(l.column, l.column + 1)
															, g = n.getTokenAt(l.row, l.column)
															, p = n.getTokenAt(l.row, l.column + 1);
														if ("\\" == h && g && /escape/.test(g.type))
															return null ;
														var m, v = g && /string|escape/.test(g.type), w = !p || /string|escape/.test(p.type);
														if (f == r)
															m = v !== w;
														else {
															if (v && !w)
							...
							f.isSaneInsertion = function(e, t) {
								...
								if (!this.$matchTokenType(n.getCurrentToken() || "text", l)) {
									var o = new s(t,i.row,i.column + 1);
									if (!this.$matchTokenType(o.getCurrentToken() || "text", l))
										return !1
								}
								return n.stepForward(),
								n.getCurrentTokenRow() !== i.row || this.$matchTokenType(n.getCurrentToken() || "text", c)
							}
								,
								...
								f.recordAutoInsert = function(e, t, i) {
									...
									this.isAutoInsertedClosing(o, r, n.autoInsertedLineEnd[0]) || (n.autoInsertedBrackets = 0),
										n.autoInsertedRow = o.row,
										n.autoInsertedLineEnd = i + r.substr(o.column),
								...
								f.recordMaybeInsert = function(e, t, i) {
									var o = e.getCursorPosition()
										, r = t.doc.getLine(o.row);
									this.isMaybeInsertedClosing(o, r) || (n.maybeInsertedBrackets = 0),
										n.maybeInsertedRow = o.row,
										n.maybeInsertedLineStart = r.substr(0, o.column) + i,
										n.maybeInsertedLineEnd = r.substr(o.column),
										n.maybeInsertedBrackets++
								}
								,
									...
									this.foldingStartMarker = /(\{|\[)[^\}\]]*$|^\s*(\/\*)/,
										...
										this.getFoldWidgetRange = function(e, t, i, n) {
											...
											if (r) {
												var s = r.index;
												if (r[1])
													return this.openingBracketBlock(e, r[1], i, s);
												var a = e.getCommentFoldRange(i, s + r[0].length, 1);
											...
											if ("markbegin" !== t) {
												...
												if (r) {
													...
													return r[1] ? this.closingBracketBlock(e, r[1], i, s) : e.getCommentFoldRange(i, s, -1)
												}
											}
										}
										,
										...
										this.getCommentRegionBlock = function(e, t, i) {
											for (var n = t.search(/\s*$/), r = e.getLength(), s = i, a = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, l = 1; ++i < r; ) {
												t = e.getLine(i);
												var c = a.exec(t);
												if (c && (c[1] ? l-- : l++,
														!l))
											...
											var h = i;
											return h > s ? new o(s,n,h,t.length) : void 0
										}
								}
									.call(s.prototype)
						}
							...
							o.inherits(d, r),
								function() {
									this.getNextLineIndent = function(e, t, i) {
										...
										,
										this.createWorker = function(e) {
											var t = new h(["ace"],i(17),"JsonWorker");
			...
			, function(e, t, i) {
				e.exports.id = "ace/mode/json_worker",
...
util.addEventListener = function(e, t, i, n) {
	if (e.addEventListener)
		return void 0 === n && (n = !1),
		"mousewheel" === t && util.isFirefox() && (t = "DOMMouseScroll"),
	...
	util.removeEventListener = function(e, t, i, n) {
		e.removeEventListener ? (void 0 === n && (n = !1),
		"mousewheel" === t && util.isFirefox() && (t = "DOMMouseScroll"),
			e.removeEventListener(t, i, n)) : e.detachEvent && e.detachEvent("on" + t, i)
	}
	,
	util.prompt = function(e) {
		var t = function() {
				...
				o.parentNode && o.parentNode.removeChild(o),
					util.removeEventListener(document, "keydown", n)
			}
			, i = function() {
				t(),
		...
		r.className = "prompt-form",
			r.target = e.formTarget || "",
			r.action = e.formAction || "",
			r.method = e.formMethod || "POST",
			...
			r.onsubmit = function() {
				return l.value ? (setTimeout(function() {
					...
					, 0),
				e.callback && e.callback(l.value, l),
				void 0 != e.formAction && void 0 != e.formMethod) : (alert("Enter a " + e.inputName + " first..."),
					!1)
			}
		;
		var s = document.createElement("div");
		if (s.className = "prompt-title",
				s.appendChild(document.createTextNode(e.title || "Dialog")),
				r.appendChild(s),
				e.description) {
			var a = document.createElement("div");
			a.className = "prompt-description",
				a.innerHTML = e.description,
				r.appendChild(a)
		}
		var l = document.createElement("input");
		l.className = "prompt-field",
			l.type = e.inputType || "text",
			l.name = e.inputName || "text",
			l.value = e.inputDefault || "";
		var c = document.createElement("div");
		c.className = "prompt-contents",
			c.appendChild(l),
			r.appendChild(c);
		var h = document.createElement("input");
		h.className = "prompt-cancel",
			h.type = "button",
			h.value = e.titleCancel || "Cancel",
			h.onclick = i;
		var d = document.createElement("input");
		d.className = "prompt-submit",
			d.type = "submit",
			d.value = e.titleSubmit || "Ok";
		var u = document.createElement("div");
		u.className = "prompt-buttons",
			u.appendChild(h),
			u.appendChild(d),
			r.appendChild(u);
		var f = document.createElement("div");
		f.className = "prompt-border",
			f.appendChild(r);
		var g = document.createElement("div");
		g.className = "prompt-background",
			g.appendChild(f),
	...
	QueryParams.prototype.getQuery = function() {
		for (var e, t, i = window.location.search.substring(1), n = i.split("&"), o = {}, r = 0, s = n.length; s > r; r++) {
			var a = n[r].split("=");
			2 == a.length ? (e = decodeURIComponent(a[0]),
				t = decodeURIComponent(a[1])) : (e = decodeURIComponent(a),
				t = ""),
				o[e] = t
		}
		return o
	...
	function e(e, t, i, n, o) {
		try {
			...
			if (r.onreadystatechange = function() {
					4 == r.readyState && o(null , r.responseText, r.status)
				}
					,
					r.open(e, t, !0),
					n)
				for (var s in n)
					n.hasOwnProperty(s) && r.setRequestHeader(s, n[s]);
			r.send(i)
		} catch (a) {
			o(a, null , 0)
		}
...
Notify.prototype.showNotification = function(e, t) {
	...
	Notify.prototype.showMessage = function(e) {
		...
		if (!t) {
			var i = 500
				, n = 5
				, o = document.body.offsetWidth || window.innerWidth;
			t = document.createElement("div"),
				t.style.position = "absolute",
				t.style.left = (o - i) / 2 + "px",
				t.style.width = i + "px",
				t.style.top = n + "px",
				t.style.zIndex = "999",
	...
	Notify.prototype.removeMessage = function(e) {
		var t = this.dom.frame;
		if (!e && t) {
			for (var i = t.firstChild; i && !i.closeable; )
				i = i.nextSibling;
			i && i.closeable && (e = i)
		}
		e && e.parentNode == t && e.parentNode.removeChild(e),
		t && 0 == t.childNodes.length && (t.parentNode.removeChild(t),
			delete this.dom.frame)
	}
	,
	Notify.prototype.onKeyDown = function(e) {
		var t = e.which;
		27 == t && (this.removeMessage(),
			e.preventDefault(),
			e.stopPropagation())
	}
	,
	...
	FileRetriever.prototype.loadUrl = function(e, t) {
		...
		var n = this
			, o = function(e, o) {
				t && (t(e, o),
					t = void 0),
				n.notify && i && (n.notify.removeMessage(i),
					i = void 0)
			}
			, r = this.scriptUrl;
		ajax.get(e, n.headers, function(t, i, s) {
				if (200 == s)
					...
					var a = r + "?url=" + encodeURIComponent(e);
					ajax.get(a, n.headers, function(t, i, n) {
							200 == n ? o(null , i) : 404 == n ? (console.log('Error: url "' + e + '" not found', n, i),
								t = new Error('Error: url "' + e + '" not found'),
								o(t, null )) : (console.log('Error: failed to load url "' + e + '"', n, i),
								t = new Error('Error: failed to load url "' + e + '"'),
								o(t, null ))
						}
					)
				}
			...
			setTimeout(function() {
					o(new Error("Error loading url (time out)"))
				}
				, this.timeout)
	}
	,
	FileRetriever.prototype.loadFile = function(e) {
		var t = void 0
			...
			, o = function(n, o, r) {
				e && (e(n, o, r),
					e = null ),
				i.notify && t && (i.notify.removeMessage(t),
					t = void 0)
			}
			, r = i.options.html5 && window.File && window.FileReader;
		if (r)
			util.prompt({
				title: "Open file",
				titleSubmit: "Open",
			...
			var s = "fileretriever-upload-" + Math.round(1e15 * Math.random())
	...
	FileRetriever.prototype.saveFile = function(e, t, i) {
		var n = t ? t + ".json" : this.defaultFilename
			, o = void 0;
		...
		var r = this
			, s = function(e) {
				i && (i(e),
					i = void 0),
				r.notify && o && (r.notify.removeMessage(o),
					o = void 0)
			}
			, a = document.createElement("a");
		this.options.html5 && void 0 != a.download && !util.isFirefox() ? (a.style.display = "none",
			a.href = "data:application/json;charset=utf-8," + encodeURIComponent(e),
			a.download = n,
			document.body.appendChild(a),
			a.click(),
			document.body.removeChild(a),
			s()) : e.length < this.options.maxSize ? ajax.post(r.scriptUrl, e, r.headers, function(e, t, i) {
				if (200 == i) {
					var o = document.createElement("iframe");
					o.src = r.scriptUrl + "?id=" + t + "&filename=" + n,
						r._hide(o),
						document.body.appendChild(o),
						s()
				} else
					s(new Error("Error saving file"))
			}
		) : s(new Error("Maximum allowed file size exceeded (" + this.options.maxSize + " bytes)")),
			setTimeout(function() {
	...
	OnlineStore.prototype.save = function(e, t, i) {
		this.queue.push({
			...
			this.revs[e._id] = e._rev,
		this.saving || this._save()
	}
	,
	OnlineStore.prototype._save = function() {
		...
		if (e) {
			var t = e.doc
				...
				, n = e.callback;
			this.saving = !0;
			var o, r = this, s = t.name || null , a = i && i.silent || !1;
			t.name = s,
				t._rev = this.revs[t._id] || t._rev,
			a || (o = this.notify.showNotification("saving document..."));
			var l = JSON.stringify(t)
				, c = {
					"content-type": "application/json"
				};
			ajax.put(this.url, l, c, function(e, i, a) {
					if (r.notify.removeMessage(o),
						200 == a) {
						var l = JSON.parse(i)
							, c = l && l.id || t._id || null
							, h = l && l.rev || t._rev || null ;
						r.revs[c] = h,
							n(null , {
								name: s || null ,
								_id: c,
						...
						n(OnlineStore._createError(e || i, new Error("Failed to save document")), null );
					r._save()
				}
			)
		} else
	...
	OnlineStore.prototype.load = function(e, t) {
		var i = this.notify
			, n = i.showNotification("loading document...");
		ajax.get(this.url + e, null , function(e, o, r) {
				i.removeMessage(n),
					200 == r ? t(null , JSON.parse(o)) : t(OnlineStore._createError(e || o, new Error("Failed to load document")), null )
			}
		)
	}
	,
	OnlineStore.prototype.remove = function(e, t) {
		var i = this.notify
			, n = i.showNotification("deleting document...");
		ajax.del(this.url + e._id + "/" + e._rev, null , function(e, o, r) {
				i.removeMessage(n),
					200 == r || 404 == r ? t(null , o) : t(OnlineStore._createError(e || o, new Error("Failed to delete document")), null )
			}
		)
	}
	,
	...
	Splitter.prototype.onMouseDown = function(e) {
		...
		i && (util.addClassName(this.container, "active"),
		this.params.mousedown || (this.params.mousedown = !0,
			this.params.mousemove = util.addEventListener(document, "mousemove", function(e) {
					t.onMouseMove(e)
				}
			),
			...
			this.params.screenX = e.screenX,
			this.params.changed = !1,
	...
	Splitter.prototype.onMouseUp = function(e) {
		if (util.removeClassName(this.container, "active"),
				this.params.mousedown) {
			util.removeEventListener(document, "mousemove", this.params.mousemove),
				util.removeEventListener(document, "mouseup", this.params.mouseup),
				this.params.mousemove = void 0,
				this.params.mouseup = void 0,
				this.params.mousedown = !1;
			var t = this.getValue();
			this.params.changed || (0 == t && (t = this.setValue(.2),
				this.onChange(t)),
			1 == t && (t = this.setValue(.8),
				this.onChange(t)))
		}
		e.preventDefault(),
			e.stopPropagation()
	...
	Splitter.prototype.setValue = function(e) {
		e = Number(e),
		void 0 != this.width && this.width > this.snap && (e < this.snap / this.width && (e = 0),
		e > (this.width - this.snap) / this.width && (e = 1)),
			this.value = e;
		try {
	...
	Splitter.prototype.getValue = function() {
		...
		if (void 0 == e)
			try {
				void 0 != localStorage.splitterValue && (e = Number(localStorage.splitterValue),
					e = this.setValue(e))
			} catch (t) {
				console.log(t)
			}
...
app.doc = {
	...
	app.localSaveTimer = null ,
	app.conflictMessages = [],
	...
	app.load = function() {
		try {
			...
			codeEditor = new JSONEditor(e,{
				...
				e = document.getElementById("treeEditor"),
			...
			i.onclick = function() {
				...
				codeEditor.aceEditor.commands.removeCommand("showSettingsMenu"),
					...
					if (e.ctrlKey)
						switch (t) {
							...
							case 190:
								...
								i ? i.focus() : treeEditor.node.dom.expand ? treeEditor.node.dom.expand.focus() : treeEditor.node.dom.menu ? treeEditor.node.dom.menu.focus() : (i = this.frame.querySelector("button"),
								i && i.focus())
						}
				}
			;
			...
			o.href = document.location.pathname + "#new",
				o.onclick = function(e) {
					app.doc._id || (document.location.href = document.location.pathname + "#new",
						location.reload())
				}
			;
			var r = document.getElementById("openFromDisk");
			...
			l.onclick = app.saveOnline,
				...
				window.onblur = app._saveOnlineIfChanged,
				document.getElementById("menu").onmouseover = app._saveOnlineIfChanged,
				...
				app.showFilesList();
			var c, h = new QueryParams, d = h.getValue("json"), u = h.getValue("url"), f = h.getValue("id"), g = "#new" == location.hash, p = "#open" == location.hash;
			if (f)
				app.openOnline(f);
			else if (d)
				codeEditor.setText(d),
					treeEditor.setText(d),
					app.changed = !1;
			else if (u)
				app.openUrl(u);
			else if (g)
				...
				location.hash = "",
					app.openFromDisk();
			else if (void 0 !== (c = localStorage.data))
				codeEditor.setText(c),
					treeEditor.setText(c),
					app.changed = !1;
			else {
				var m = {
					array: [1, 2, 3],
	...
	app.setChanged = function(e) {
		app.lastChanged = e,
			app.changed = !0,
			app.doc._id ? (app.showStatus('changed (<a href="javascript: app._saveOnline(true)">save now</a>)'),
			app.autoSaveTimer && clearTimeout(app.autoSaveTimer),
				app.autoSaveTimer = setTimeout(app._saveOnlineIfChanged, AUTO_SAVE_DELAY)) : (app.localSaveTimer && clearTimeout(app.localSaveTimer),
				app.localSaveTimer = setTimeout(function() {
						app.changed && (app.changed = !1,
							localStorage.data = app.getData())
					}
					, LOCAL_SAVE_DELAY))
	}
	,
	...
	app.setData = function(e) {
		...
		try {
			...
			treeEditor.set({}),
				app.notify.showError(app.formatError(i))
		}
	}
	,
	app.setMetaData = function(e) {
		void 0 != e._id && (this.doc._id = e._id),
		void 0 != e._rev && (this.doc._rev = e._rev),
		void 0 != e.name && (this.doc.name = e.name),
		e._id && app.showName(e.name || "unnamed document")
	}
	,
	app.showName = function(e) {
		for (var t = document.getElementById("name"); t.firstChild; )
			t.removeChild(t.firstChild);
		t.appendChild(document.createTextNode(e)),
			t.style.visibility = "visible",
			document.title = e + " - JSON Editor Online"
	}
	,
	app.openFromDisk = function() {
		app.doc._id ? document.location.href = document.location.pathname + "#open" : app.retriever.loadFile(function(e, t, i) {
				e ? app.notify.showError(e) : (app.setData(t),
					app.setMetaData({
						name: util.getName(i)
					}))
			}
	...
	app.openUrl = function(e) {
		function t(t, i) {
			console.log("url", e),
				t ? app.notify.showError(t) : i && (app.setData(i),
					app.setMetaData({
						name: util.getName(e)
					}))
		}
	...
	app.saveLocal = function(e) {
		...
		i[e._id] = {
			...
			localStorage.files = JSON.stringify(i),
			app.showFilesList(i)
	}
	,
	app.lastFilesStr = null ,
	app.showFilesList = function(e) {
		if (!e) {
			var t = localStorage.files;
			e = t ? JSON.parse(t) : {}
		}
		if (app.lastFilesStr != t) {
			...
			n.length > 0 && n.forEach(function(t) {
					...
					r.className = "open",
						r.href = location.pathname + "?id=" + t,
						r.appendChild(document.createTextNode(n.name || t)),
						r.title = "Date: " + n.updated.substring(0, 19).replace("T", " "),
						o.appendChild(r);
					var s = document.createElement("a");
					s.className = "remove",
						s.innerHTML = "&times;",
						s.title = 'Delete "' + n.name + '"',
						s.onclick = function(e) {
							e.stopPropagation(),
								e.preventDefault(),
							confirm('Are you sure you want to delete document "' + n.name + '"?\n\nThis action cannot be undone') && app.removeOnline(n)
						}
						,
						o.appendChild(s),
						i.appendChild(o)
	...
	app._saveOnline = function(e) {
		...
		app.doc._id && app.doc._rev && (t._id = app.doc._id,
			t._rev = app.doc._rev),
			app.changed = !1;
		var i = {
			silent: e
		};
		app.showStatus("saving changes..."),
			app.store.save(t, i, function(t, i) {
					if (t)
						"Error: Document update conflict." == t.toString() && (t = new Error('Document update conflict.<p>This document has been changed in an other browser or tab.</p><p>Solutions:</p><ul><li><a href="javascript: location.reload();">load latest version from the server</a> (overrides your local changes)</li><li><a href="javascript: app._forceSaveOnline();">save my version to the server</a> (overrides the changes on the server)</li></ul>')),
							app.conflictMessages.push(app.notify.showError(t)),
							app.showStatus("failed to save");
					else {
						app.saveLocal(i),
							app.setMetaData(i),
							app.showStatus("saved"),
						e || app.notify.showNotification('file has been saved as "' + app.doc.name + '"', 1e3);
	...
	app._forceSaveOnline = function() {
		for (var e; e = app.conflictMessages.shift(); )
			app.notify.removeMessage(e);
		app.store.load(app.doc._id, function(e, t) {
				e ? app.notify.showError(e) : (app.setMetaData(t),
					app.saveLocal(t),
					app._saveOnline())
			}
		)
	...
	app.removeOnline = function(e) {
		app.store.remove(e, function(t, i) {
				if (t)
					app.notify.showError(t);
				else {
					var n = localStorage.files
						, o = n ? JSON.parse(n) : {};
					delete o[e._id],
						localStorage.files = JSON.stringify(o),
						app.doc._id == e._id ? (app.changed = !1,
							document.location.href = document.location.pathname + "#new") : app.showFilesList(o)
				}
			}
		)
	}
	...
	app.openOnline = function(e) {
		app.changed = !1,
			app.store.load(e, function(e, t) {
					e ? app.notify.showError(e) : (app.setData(t.data),
						app.setMetaData(t),
						app.saveLocal(t),
						app.changed = !1,
						app.showStatus("saved"))
	...
	app.formatError = function(e) {
		var t = e.toString().replace(/</g, "&lt;").replace(/>/g, "&gt;")
			, i = '<pre class="error">' + t + "</pre>";
		return "undefined" != typeof jsonlint && (i += '<a class="error" href="http://zaach.github.com/jsonlint/" target="_blank">validated by jsonlint</a>'),
			i
	}
	,
	...
	app.resize = function() {
		...
		if (c && (l -= c + a),
			...
			var g, p = n.clientWidth;
			if (d)
				if (u) {
					g = l * h - p / 2;
					var m = 8 == util.getInternetExplorerVersion();
					r.innerHTML = m ? "|" : "&#8942;",
						r.title = "Drag left or right to change the width of the panels"
				} else
					g = l * h - p,
						r.innerHTML = "&lsaquo;",
						r.title = "Drag left to show the tree editor";
			else
				g = 0,
					r.innerHTML = "&rsaquo;",
					r.title = "Drag right to show the code editor";
			i.style.display = 0 == h ? "none" : "",
				i.style.width = Math.max(Math.round(g), 0) + "px",
				codeEditor.resize(),
				r.style.height = n.clientHeight - o.clientHeight - 2 * a - (f ? a : 0) + "px",
				r.style.lineHeight = r.style.height,
				t.style.display = 1 == h ? "none" : "",
				t.style.left = Math.round(g + p) + "px",
				t.style.width = Math.max(Math.round(l - g - p - 2), 0) + "px"
		}
	...
	window.addEventListener("load", function() {
			...
			if (e && "function" == typeof window.getComputedStyle) {
				...
				e.style.width = t.getPropertyValue("width"),
					e.style.height = t.getPropertyValue("height")
			}
		}
	);
